...
// Constructor
HomingCancelled::HomingCancelled() {
    references= 0;
...
// Getter for header
//org_himalay_ccif_APDUHeader__PTR_TYPE HomingCancelled::getHeader()
//{
//return this->header;
//}

// Setter for header
//void HomingCancelled::setHeader(org_himalay_ccif_APDUHeader__PTR_TYPE val)
//{
//this->header= val;
//}

// Getter for length
//ui8 HomingCancelled::getLength()
//{
//return this->length;
//}

// Setter for length
//void HomingCancelled::setLength(ui8 val)
//{
//this->length= val;
//}

int HomingCancelled::getSize() { // throws IOException
    int retVal = 0;

    return retVal;
}

void HomingCancelled::setHeader(org_himalay_ccif_APDUHeader__PTR_TYPE header)
{
    this->header= header;
}
