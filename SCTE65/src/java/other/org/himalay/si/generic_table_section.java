...
public  class generic_table_section extends   SCTE65TableFactory.SCTE65Table { //Concrete type is generic_table_section
    ...
    public long CRC ;
        ...
        public generic_table_section () // throws Exception
    {
            init();
    }
  ...
  preRead();
    int retVal= 0;
        ...
        // read data
        {data.setSizeType("EXTERNAL");   int iRead  = tableHeader.getSection_length()+(-5); data.setSize(iRead);retVal+=data.read(istream); }
        // read CRC
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("generic_table_section\n");
    dc.increaseIndent();
        int retVal= 0;
        // write tableHeader
