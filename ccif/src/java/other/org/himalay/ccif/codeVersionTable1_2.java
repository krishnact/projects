...
public  class codeVersionTable1_2 extends   APDUBaseFactory.APDUBase { //Concrete type is codeVersionTable1_2
...
// member static classes
    public  static  class statusfld extends BinStruct implements PublicBinMsg {
        ...
        public statusfld (codeVersionTable1_2 parent) // throws Exception
        {
            this.parent= parent;
            init();
        }
        public codeVersionTable1_2 getParent()
        {
            return parent;
        }
        ...
        public int read(DataInputStream istream) throws IOException
        {
            ...
            {
                frequencyVector=istream.readUnsignedShort();
                retVal+=2;
            }
            // read modulationType
            {
                modulationType=(short)(istream.readUnsignedByte());
                retVal+=1;
            }
            // read bf1
        ...
        public int write(DataOutputStream ostream) throws IOException
        {
            ...
            ostream.writeShort(frequencyVector);
            retVal +=2;
            // write modulationType
            ostream.writeByte(modulationType);
            retVal +=1;
            // write bf1
        ...
        public int dump(DumpContext dc) throws IOException
        {
            ...
            // write frequencyVector
            dc.indent();
            dc.getPs().println("frequencyVector="+frequencyVector+"(0x"+ Integer.toHexString(frequencyVector) + ")" );
            // write modulationType
            dc.indent();
            dc.getPs().println("modulationType="+modulationType+"(0x"+ Integer.toHexString(modulationType) + ")" );
            // write bf1
            {
                dc.indent();
...
// member static classes
    public  static  class statusfld2 extends BinStruct implements PublicBinMsg {
        ...
        // Parent of this object
        codeVersionTable1_2 parent;
        public statusfld2 (codeVersionTable1_2 parent) // throws Exception
        {
            this.parent= parent;
            init();
        }
        ...
        public int read(DataInputStream istream) throws IOException
        {
            ...
            {
                sourcePortNumber=istream.readUnsignedShort();
                retVal+=2;
            }
            // read destinatioPortNumber
            {
                destinatioPortNumber=istream.readUnsignedShort();
                retVal+=2;
            }
            // read applicationId
            {
                applicationId=istream.readUnsignedShort();
                retVal+=2;
            }
            // read modulationType
            {
        ...
        public int write(DataOutputStream ostream) throws IOException
        {
            ...
            ostream.writeShort(sourcePortNumber);
            retVal +=2;
            // write destinatioPortNumber
            ostream.writeShort(destinatioPortNumber);
            retVal +=2;
            // write applicationId
            ostream.writeShort(applicationId);
            retVal +=2;
            // write modulationType
            ostream.writeByte(modulationType);
            retVal +=1;
        ...
        public int dump(DumpContext dc) throws IOException
        {
            ...
            // write sourcePortNumber
            dc.indent();
            dc.getPs().println("sourcePortNumber="+sourcePortNumber+"(0x"+ Integer.toHexString(sourcePortNumber) + ")" );
            // write destinatioPortNumber
            dc.indent();
            dc.getPs().println("destinatioPortNumber="+destinatioPortNumber+"(0x"+ Integer.toHexString(destinatioPortNumber) + ")" );
            // write applicationId
            dc.indent();
            dc.getPs().println("applicationId="+applicationId+"(0x"+ Integer.toHexString(applicationId) + ")" );
            // write modulationType
            dc.indent();
            dc.getPs().println("modulationType="+modulationType+"(0x"+ Integer.toHexString(modulationType) + ")" );
            // write bf2
...
// member static classes
    public  static  class statusfld3 extends BinStruct implements PublicBinMsg {
        ...
        // Parent of this object
        codeVersionTable1_2 parent;
        public statusfld3 (codeVersionTable1_2 parent) // throws Exception
        {
            this.parent= parent;
            init();
        }
...
// End of code
    ...
    public codeVersionTable1_2 () // throws Exception
    {
        init();
    }
    ...
    private void init()
    {
        ...
        // Initialize pgmmsg
        pgmmsg= new ArrayList<codeVersionTableMsg>();
    ...
    public int readNoHeader(DataInputStream istream) throws IOException
    {
        ...
        {
            configurationCountChange=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
        // read statusField
        {
        ...
        for (; istream.available() > 0 ; ) {
            codeVersionTableMsg temp;
            temp = new codeVersionTableMsg();
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        ostream.writeByte(configurationCountChange);
        retVal +=1;
        // write statusField
        ...
        // write pgmmsg
        {
            ArrayList<codeVersionTableMsg> temp1 = pgmmsg;
            for (int iIdx=0; iIdx < temp1.getCount() ; iIdx++) {
                codeVersionTableMsg temp2    =    temp1.get(iIdx);
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write configurationCountChange
        dc.indent();
        dc.getPs().println("configurationCountChange="+configurationCountChange+"(0x"+ Integer.toHexString(configurationCountChange) + ")" );
        // write statusField
        dc.indent();
        ...
        // write pgmmsg
        {
            ArrayList<codeVersionTableMsg> temp1 = pgmmsg;
            for (int iIdx=0; iIdx < temp1.getCount() ; iIdx++) {
                codeVersionTableMsg element    = temp1.get(iIdx);
                dc.indent();
        ...
        // write bf1
        {
            ...
            dc.getPs().println(BitField_8.toDisplayString(getDownloadCommand(),4));
        }
        // write statusfldInstance
        ...
        // write codeFileByte
        dc.indent();
        dc.getPs().print("codeFileByte: "+codeFileByte.getSize()+"(0x"+Integer.toHexString(codeFileByte.getSize())+")\n");
