...
public  class FeatureListReq extends   APDUBaseFactory.APDUBase { //Concrete type is FeatureListReq
    ...
    public short length ;
        ...
        public FeatureListReq () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("FeatureListReq\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
