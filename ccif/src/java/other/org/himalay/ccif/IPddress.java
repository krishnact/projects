...
public  class IPddress extends BinStruct implements PublicBinMsg{
    ...
    public ByteArray data ;
        ...
        public IPddress () // throws Exception
    {
            init();
    }
    ...
    {
        // Initialize data
        data= new ByteArray();data.setSizeType("FIXED");data.setSize(6);
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("IPddress\n");
    dc.increaseIndent();
        int retVal= 0;
        // write data
