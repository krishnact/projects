...
public  class SAS_data_rqst extends   APDUBaseFactory.APDUBase { //Concrete type is SAS_data_rqst
    ...
    public short length ;
        ...
        public SAS_data_rqst () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("SAS_data_rqst\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
