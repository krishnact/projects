...
public  class DSG_error extends   APDUBaseFactory.APDUBase { //Concrete type is DSG_error
    ...
    public short errorStatus ;
        ...
        public DSG_error () // throws Exception
    {
            init();
    }
  ...
  preRead();
    int retVal= 0;
        ...
        // read errorStatus
        {errorStatus=(short)(istream.readUnsignedByte()); retVal+=1;}
...
postRead();
    ...
    preWrite();
        ...
        // write errorStatus
        ostream.writeByte(errorStatus); retVal +=1;
postWrite();
        return retVal;
    }
    ...
    {
        dc.indent();dc.getPs().print("DSG_error\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
        ...
        // write errorStatus
        dc.indent();dc.getPs().println("errorStatus="+errorStatus+"(0x"+ Integer.toHexString(errorStatus) + ")" );
dc.decreaseIndent();
        return retVal;
    }
    ...
    //public void setErrorStatus(short val)
    //{
