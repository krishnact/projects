...
public  class EsProfileCnf extends   APDUBaseFactory.APDUBase { //Concrete type is EsProfileCnf
    ...
    public short length ;
        ...
        public EsProfileCnf () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("EsProfileCnf\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
