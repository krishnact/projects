...
public  class HomingComplete extends   APDUBaseFactory.APDUBase { //Concrete type is HomingComplete
    ...
    public short length ;
        ...
        public HomingComplete () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("HomingComplete\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
