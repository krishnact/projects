...
public  class CpDataCnfKey extends   APDUBaseFactory.APDUBase { //Concrete type is CpDataCnfKey
    ...
    public ArrayList<CpDataReqMsg> cadatanbr ;
        ...
        public CpDataCnfKey () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("CpDataCnfKey\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
