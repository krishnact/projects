...
public  class OpenHomingReply extends   APDUBaseFactory.APDUBase { //Concrete type is OpenHomingReply
    ...
    public short length ;
        ...
        public OpenHomingReply () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("OpenHomingReply\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
