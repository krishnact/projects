...
public  class FeatureParamtersReq extends   APDUBaseFactory.APDUBase { //Concrete type is FeatureParamtersReq
    ...
    public short length ;
        ...
        public FeatureParamtersReq () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("FeatureParamtersReq\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
