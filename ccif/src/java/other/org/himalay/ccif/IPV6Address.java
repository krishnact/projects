...
public  class IPV6Address extends BinStruct implements PublicBinMsg{
    ...
    {
        // Initialize data
        data= new ByteArray();data.setSizeType("FIXED");data.setSize(16);
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("IPV6Address\n");
    dc.increaseIndent();
        int retVal= 0;
        // write data
