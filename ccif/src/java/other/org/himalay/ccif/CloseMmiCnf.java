...
public  class CloseMmiCnf extends   APDUBaseFactory.APDUBase { //Concrete type is CloseMmiCnf
    ...
    public short dialogNumber ;
        ...
        public CloseMmiCnf () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("CloseMmiCnf\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
