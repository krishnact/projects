...
public  class ResourceHeader extends BinStruct implements PublicBinMsg {
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        // read descriptor_len
        {
            descriptor_len=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        ostream.writeByte(descriptor_len);
        retVal +=1;
        postWrite();
        return retVal;
    }
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write descriptor_len
        dc.indent();
        dc.getPs().println("descriptor_len="+descriptor_len+"(0x"+ Integer.toHexString(descriptor_len) + ")" );
        dc.decreaseIndent();
        return retVal;
    }
