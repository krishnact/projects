...
public  class TimeZone extends BinStruct implements PublicBinMsg{
    ...
    preRead();
        int retVal= 0;
                     ...
                     // read timeZoneOffset
        {timeZoneOffset=istream.readUnsignedShort(); retVal+=2;}
    ...
    preWrite();
        ...
        ostream.writeShort(timeZoneOffset); retVal +=2;
postWrite();
        return retVal;
    }
    ...
    {
        dc.indent();dc.getPs().print("TimeZone\n");
    dc.increaseIndent();
        int retVal= 0;
        // write timeZoneOffset
        dc.indent();dc.getPs().println("timeZoneOffset="+timeZoneOffset+"(0x"+ Integer.toHexString(timeZoneOffset) + ")" );
dc.decreaseIndent();
        return retVal;
    }
