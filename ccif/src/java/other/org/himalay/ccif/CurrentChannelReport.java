...
public  class CurrentChannelReport extends BinStruct implements PublicBinMsg {
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        // read currentChannel
        {
            currentChannel=istream.readUnsignedShort();
            retVal+=2;
        }
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        ostream.writeShort(currentChannel);
        retVal +=2;
        postWrite();
        return retVal;
    }
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write bf1
        {
            ...
            dc.getPs().println(BitField_8.toDisplayString(getChannelType(),1));
            dc.indent();
            dc.getPs().print("authorizationFlag: ");
            dc.getPs().println(BitField_8.toDisplayString(getAuthorizationFlag(),1));
            dc.indent();
            dc.getPs().print("purchasableFlag: ");
            dc.getPs().println(BitField_8.toDisplayString(getPurchasableFlag(),1));
            dc.indent();
            dc.getPs().print("purchasedFlag: ");
            dc.getPs().println(BitField_8.toDisplayString(getPurchasedFlag(),1));
            dc.indent();
            dc.getPs().print("previewFlag: ");
            dc.getPs().println(BitField_8.toDisplayString(getPreviewFlag(),1));
            dc.indent();
            dc.getPs().print("parentalControlFlag: ");
            dc.getPs().println(BitField_8.toDisplayString(getParentalControlFlag(),1));
        }
        // write currentChannel
        dc.indent();
        dc.getPs().println("currentChannel="+currentChannel+"(0x"+ Integer.toHexString(currentChannel) + ")" );
        dc.decreaseIndent();
        return retVal;
    }
