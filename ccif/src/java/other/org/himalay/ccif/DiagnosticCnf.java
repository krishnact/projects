...
public  class DiagnosticCnf extends   APDUBaseFactory.APDUBase { //Concrete type is DiagnosticCnf
    ...
    private void init()
    {
        ...
        numberOfDiag= new ByteArray();numberOfDiag.setSizeType("FIRST_UI8");
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("DiagnosticCnf\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
        ...
        // write numberOfDiag
        dc.indent();dc.getPs().print("numberOfDiag: "+numberOfDiag.getSize()+"(0x"+Integer.toHexString(numberOfDiag.getSize())+")\n");this.numberOfDiag.dump(dc);
dc.decreaseIndent();
        return retVal;
    }
