...
public static  app_desc_base lastParsedObject= null;
    public static app_desc_base createMsg(DataInputStream istream, IntegerHolder iHolder1) throws IOException
    {
int iRead=0;
...
iRead= retVal;
    ...
    public static app_desc_base createMsg( org.himalay.si.descriptor_header temp, DataInputStream dis, IntegerHolder iHolder) throws IOException
    {
        int iRead= 0;
...
//dis= new DataInputStream(new ByteArrayInputStream(ba));
        ...
        return retVal;
                ...
                public static abstract class app_desc_base extends BinMessage implements FactoryProduct {
