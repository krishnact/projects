...
public:
    class Resource : public BinMessage {
    public:
        Resource();
    public:
        virtual ~Resource();
    ...
    public:
        virtual void setHeader(org_himalay_cl_cdl_ResourceHeader__PTR_TYPE header)=0;
    public:
        virtual org_himalay_cl_cdl_ResourceHeader__PTR_TYPE getHeader()=0;

        // Resource: df9689f9-64f1-4110-b51e-e4c61818db7e used as header is false
...
public:
    static org_himalay_cl_cdl_ResourceFactory_Resource__PTR_TYPE createMsg(DataInputStream& dis, int& iHolder) throw( IOException);
public:
    static org_himalay_cl_cdl_ResourceFactory_Resource__PTR_TYPE createMsg( org_himalay_cl_cdl_ResourceHeader__PTR_TYPE temp, DataInputStream& dis, int& iHolder) throw( IOException);
