...
public  class CaInfo extends BinStruct implements PublicBinMsg{
    ...
    private void init()
    {
        ...
        CaDescriptors= new ByteArray();CaDescriptors.setSizeType("EOS");
    }
    ...
    preRead();
        int retVal= 0;
                     ...
                     // read caPmtId
        {caPmtId=(short)(istream.readUnsignedByte()); retVal+=1;}
        // read CaDescriptors
    ...
    preWrite();
        ...
        { /** fix dependent sizes for CaDescriptors**/  }
                ...
                // write caPmtId
        ostream.writeByte(caPmtId); retVal +=1;
        // write CaDescriptors
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("CaInfo\n");
    dc.increaseIndent();
        int retVal= 0;
        // write caPmtId
        dc.indent();dc.getPs().println("caPmtId="+caPmtId+"(0x"+ Integer.toHexString(caPmtId) + ")" );
        // write CaDescriptors
        dc.indent();dc.getPs().print("CaDescriptors: "+CaDescriptors.getSize()+"(0x"+Integer.toHexString(CaDescriptors.getSize())+")\n");this.CaDescriptors.dump(dc);
dc.decreaseIndent();
        return retVal;
    }
