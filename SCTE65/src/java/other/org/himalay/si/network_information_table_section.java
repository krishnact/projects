...
public class network_information_table_section
    extends
    SCTE65TableFactory.SCTE65Table { // Concrete type is
    // network_information_table_section
    ...
    public static class subtable extends BinStruct implements PublicBinMsg {
        ...
        public subtable(network_information_table_section parent) // throws
        // Exception
        {
            this.parent = parent;
            init();
        ...
        public int read(DataInputStream istream) throws IOException {
            ...
            // read firstIndex
            {
                firstIndex = (short) (istream.readUnsignedByte());
                retVal += 1;
            }
            // read numberOfRecords
            {
                numberOfRecords = (short) (istream.readUnsignedByte());
                retVal += 1;
            }
            // read bf3
        ...
        public int write(DataOutputStream ostream) throws IOException {
...

            {
                ...
                numberOfRecords = ((short) records.getCount());
            }
            {
            ...
            // write firstIndex
            ostream.writeByte(firstIndex);
            retVal += 1;
            // write numberOfRecords
            ostream.writeByte(numberOfRecords);
            retVal += 1;
            // write bf3
        ...
        public int dump(DumpContext dc) throws IOException {
            ...
            dc.indent();
            dc.getPs().println(
                "firstIndex=" + firstIndex + "(0x"
                + Integer.toHexString(firstIndex) + ")");
            // write numberOfRecords
            dc.indent();
            dc.getPs().println(
                "numberOfRecords=" + numberOfRecords + "(0x"
                + Integer.toHexString(numberOfRecords) + ")");
            // write bf3
            {
                dc.indent();
        ...
        public void setTransmission_medium(int val) {
            bf3.setValue((bf3.getValue() & 0xffffff0f)
                         | ((val << 4) & 0x000000f0));
        }
        ...
        public void setTable_subtype(int val) {
            bf3.setValue((bf3.getValue() & 0xfffffff0)
                         | ((val << 0) & 0x0000000f));
        }
