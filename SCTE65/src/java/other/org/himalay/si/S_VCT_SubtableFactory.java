...
public static  S_VCT_Subtable lastParsedObject= null;
    public static S_VCT_Subtable createMsg( int messageType, DataInputStream dis, IntegerHolder iHolder) throws IOException
    {
        int iRead= 0;
        ...
        return retVal;
                ...
                public static abstract class S_VCT_Subtable extends BinMessage implements FactoryProduct {
