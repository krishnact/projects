...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("PortReportSMode1394\n");
    dc.increaseIndent();
        int retVal= 0;
        // write totalNumberOfNodes
        dc.indent();dc.getPs().println("totalNumberOfNodes="+totalNumberOfNodes+"(0x"+ Integer.toHexString(totalNumberOfNodes) + ")" );
        // write bf1
        {dc.indent();dc.getPs().print("reserved: ");dc.getPs().println(BitField_8.toDisplayString(getReserved(),3));dc.indent();dc.getPs().print("loopStatus: ");dc.getPs().println(BitField_8.toDisplayString(getLoopStatus(),1));dc.indent();dc.getPs().print("rootStatus: ");dc.getPs().println(BitField_8.toDisplayString(getRootStatus(),1));dc.indent();dc.getPs().print("cycleMasterStatus: ");dc.getPs().println(BitField_8.toDisplayString(getCycleMasterStatus(),1));dc.indent();dc.getPs().print("port_1ConnectionStatus: ");dc.getPs().println(BitField_8.toDisplayString(getPort_1ConnectionStatus(),1));dc.indent();dc.getPs().print("port_2ConnectionStatus: ");dc.getPs().println(BitField_8.toDisplayString(getPort_2ConnectionStatus(),1));}
dc.decreaseIndent();
        return retVal;
    }
