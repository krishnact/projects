...
public class dvbJapp_descriptor extends app_desc_baseFactory.app_desc_base { // Concrete
																				// type
																				// is
																				// dvbJapp_descriptor
	...
	public int write(DataOutputStream ostream) throws IOException {
		...
		{
			/** fix dependent sizes for params **/
			desc_header.length = ((short) params.getSize());
		}
		...
		// write params
		{
			ArrayList<Param> temp1 = params;
			for (int iIdx = 0; iIdx < temp1.getCount(); iIdx++) {
				Param temp2 = temp1.get(iIdx);
				if (temp2 != null)
