...
// End of code
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        if(getEsInfoLength()!= 0) {
            esfieldCheckInstance = new esfieldCheck(this);
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write bf2
        {
            ...
            dc.getPs().println(BitField_8.toDisplayString(getEsInfoLength(),12));
        }
        // write bf3
        {
            dc.indent();
            ...
            dc.getPs().println(BitField_8.toDisplayString(getElementryPid(),13));
        }
        // write esfieldCheckInstance
