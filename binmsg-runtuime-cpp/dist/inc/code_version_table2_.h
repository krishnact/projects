...
//    long    references;
  ...
  public:
    ...
    // members variables
    // header ---
    public: org_himalay_cl_cdl_Header__PTR_TYPE header ;
    // protocol_version ---
    public: ui8 protocol_version ;
    // configuration_count_change ---
    public: ui8 configuration_count_change ;
    // resources ---
    public: org_himalay_cl_cdl_Resources__PTR_TYPE resources ;
    // pvData ---
    public: org_himalay_cl_cdl_PVDataFactory_PVData__PTR_TYPE  pvData ;
    // certificateCount ---
    public: ui8 certificateCount ;
    // cvCertificates ---
    ...
    public: void setHeader(org_himalay_cl_cdl_Header__PTR_TYPE header);
