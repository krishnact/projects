...
public  class FeatureListCnf extends   APDUBaseFactory.APDUBase { //Concrete type is FeatureListCnf
    ...
    public short length ;
        ...
        public FeatureListCnf () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("FeatureListCnf\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
