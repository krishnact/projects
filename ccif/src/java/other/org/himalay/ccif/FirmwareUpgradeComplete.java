...
public  class FirmwareUpgradeComplete extends   APDUBaseFactory.APDUBase { //Concrete type is FirmwareUpgradeComplete
    ...
    public int readNoHeader(DataInputStream istream) throws IOException
    {
        ...
        {
            resetRequestStatus=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        ostream.writeByte(resetRequestStatus);
        retVal +=1;
        postWrite();
        return retVal;
    }
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write resetRequestStatus
        dc.indent();
        dc.getPs().println("resetRequestStatus="+resetRequestStatus+"(0x"+ Integer.toHexString(resetRequestStatus) + ")" );
        dc.decreaseIndent();
        return retVal;
    }
