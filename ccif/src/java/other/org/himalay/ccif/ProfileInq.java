...
public  class ProfileInq extends   APDUBaseFactory.APDUBase { //Concrete type is ProfileInq
    ...
    public short length ;
        ...
        public ProfileInq () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("ProfileInq\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
