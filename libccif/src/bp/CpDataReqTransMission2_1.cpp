...
// Constructor
CpDataReqTransMission2_1::CpDataReqTransMission2_1() {
    references= 0;
...
int CpDataReqTransMission2_1::readNoHeader(DataInputStream&  istream ) { // throws IOException
    int retVal = 0;
...
int CpDataReqTransMission2_1::read(DataInputStream&  istream ) { // throws IOException
    int retVal = 0;
    // read header
...
int CpDataReqTransMission2_1::write(DataOutputStream& ostream) { // throws IOException
...
int CpDataReqTransMission2_1::dump(DumpContext& dc) { // throws IOException
    dc.indent();
    dc.getPs().print("CpDataReqTransMission2_1\n");
    dc.increaseIndent();
    int retVal= 0;
    // write header
    if ( header != NULL ) {
...
// Getter for header
//org_himalay_ccif_APDUHeader__PTR_TYPE CpDataReqTransMission2_1::getHeader()
//{
//return this->header;
//}

// Setter for header
//void CpDataReqTransMission2_1::setHeader(org_himalay_ccif_APDUHeader__PTR_TYPE val)
//{
//this->header= val;
//}

// Getter for length
//ui8 CpDataReqTransMission2_1::getLength()
//{
//return this->length;
//}

// Setter for length
//void CpDataReqTransMission2_1::setLength(ui8 val)
//{
//this->length= val;
//}

// Getter for cpSystemId
//ui8 CpDataReqTransMission2_1::getCpSystemId()
//{
//return this->cpSystemId;
//}

// Setter for cpSystemId
//void CpDataReqTransMission2_1::setCpSystemId(ui8 val)
//{
//this->cpSystemId= val;
//}

// Getter for cadatanbr
//ArrayList(CpDataReqMsg) CpDataReqTransMission2_1::getCadatanbr()
//{
//return this->cadatanbr;
//}

// Setter for cadatanbr
//void CpDataReqTransMission2_1::setCadatanbr(ArrayList(CpDataReqMsg) val)
//{
//this->cadatanbr= val;
//}

// Getter for DataType_id
//org_himalay_msgs_runtime_ByteArray_PTR_TYPE CpDataReqTransMission2_1::getDataType_id()
//{
//return this->DataType_id;
//}

// Setter for DataType_id
//void CpDataReqTransMission2_1::setDataType_id(org_himalay_msgs_runtime_ByteArray_PTR_TYPE val)
//{
//this->DataType_id= val;
//}

int CpDataReqTransMission2_1::getSize() { // throws IOException
    int retVal = 0;

    return retVal;
}

void CpDataReqTransMission2_1::setHeader(org_himalay_ccif_APDUHeader__PTR_TYPE header)
{
    this->header= header;
}
