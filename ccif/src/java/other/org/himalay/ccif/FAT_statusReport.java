...
public  class FAT_statusReport extends BinStruct implements PublicBinMsg {
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        // read SNR
        {
            SNR=istream.readUnsignedShort();
            retVal+=2;
        }
        // read signalLevel
        {
            signalLevel=istream.readUnsignedShort();
            retVal+=2;
        }
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        retVal +=1;
        // write SNR
        ostream.writeShort(SNR);
        retVal +=2;
        // write signalLevel
        ostream.writeShort(signalLevel);
        retVal +=2;
        postWrite();
        return retVal;
    }
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write bf1
        {
            ...
            dc.getPs().println(BitField_8.toDisplayString(getPCR_lock(),1));
            dc.indent();
            dc.getPs().print("modulationMode: ");
            dc.getPs().println(BitField_8.toDisplayString(getModulationMode(),2));
            dc.indent();
        ...
        // write SNR
        dc.indent();
        dc.getPs().println("SNR="+SNR+"(0x"+ Integer.toHexString(SNR) + ")" );
        // write signalLevel
        dc.indent();
        dc.getPs().println("signalLevel="+signalLevel+"(0x"+ Integer.toHexString(signalLevel) + ")" );
        dc.decreaseIndent();
        return retVal;
    }
