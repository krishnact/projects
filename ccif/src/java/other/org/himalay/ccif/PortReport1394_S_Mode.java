...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("PortReport1394_S_Mode\n");
    dc.increaseIndent();
        int retVal= 0;
        // write bf1
        {dc.indent();dc.getPs().print("reserved: ");dc.getPs().println(BitField_8.toDisplayString(getReserved(),3));dc.indent();dc.getPs().print("loopStatus: ");dc.getPs().println(BitField_8.toDisplayString(getLoopStatus(),1));dc.indent();dc.getPs().print("rootStatus: ");dc.getPs().println(BitField_8.toDisplayString(getRootStatus(),1));dc.indent();dc.getPs().print("cycleMasterStatus: ");dc.getPs().println(BitField_8.toDisplayString(getCycleMasterStatus(),1));dc.indent();dc.getPs().print("port_1_ConnectionStatus: ");dc.getPs().println(BitField_8.toDisplayString(getPort_1_ConnectionStatus(),1));dc.indent();dc.getPs().print("port_2_ConnectionStatus: ");dc.getPs().println(BitField_8.toDisplayString(getPort_2_ConnectionStatus(),1));}
        // write totalNumberOfNodes
