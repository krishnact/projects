...
public  class IPV4Address extends BinStruct implements PublicBinMsg{
    ...
    {
        // Initialize data
        data= new ByteArray();data.setSizeType("FIXED");data.setSize(4);
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("IPV4Address\n");
    dc.increaseIndent();
        int retVal= 0;
        // write data
