#ifndef ORG_HIMALAY_CCIF_NEWFLOWREQUEST1_1AND1_2
#define ORG_HIMALAY_CCIF_NEWFLOWREQUEST1_1AND1_2
 ...
 */
#define org_himalay_ccif_NewFlowRequest1_1and1_2__USE_SMART_PTR
#ifdef org_himalay_ccif_NewFlowRequest1_1and1_2__USE_SMART_PTR
#include "boost/shared_ptr.hpp"
#define org_himalay_ccif_NewFlowRequest1_1and1_2__PTR_TYPE boost::shared_ptr<NewFlowRequest1_1and1_2>
#define org_himalay_ccif_NewFlowRequest1_1and1_2__NEW(x) {/** Serious **/x = org_himalay_ccif_NewFlowRequest1_1and1_2__PTR_TYPE(new NewFlowRequest1_1and1_2()); }
#define org_himalay_ccif_NewFlowRequest1_1and1_2__INIT(x)
#define org_himalay_ccif_NewFlowRequest1_1and1_2__DELETE(x)
#else
#define org_himalay_ccif_NewFlowRequest1_1and1_2__PTR_TYPE NewFlowRequest1_1and1_2*
#define org_himalay_ccif_NewFlowRequest1_1and1_2__NEW(x) {x= new NewFlowRequest1_1and1_2();}
#define org_himalay_ccif_NewFlowRequest1_1and1_2__INIT(x)  x=NULL;
#define org_himalay_ccif_NewFlowRequest1_1and1_2__DELETE(x)  {delete(x);x=NULL;}
#endif
...
#ifdef org_himalay_ccif_NewFlowRequest1_1and1_2__USE_SMART_PTR
class NewFlowRequest1_1and1_2;
typedef ::boost::shared_ptr<NewFlowRequest1_1and1_2> NewFlowRequest1_1and1_2Ptr;
#endif

class NewFlowRequest1_1and1_2 :public   APDUBase_1Factory::APDUBase_1 { //Concrete type is NewFlowRequest1_1and1_2
...
public:
    NewFlowRequest1_1and1_2 (); // throws Exception
    virtual ~NewFlowRequest1_1and1_2 ();
public:
...
#endif // ORG_HIMALAY_CCIF_NEWFLOWREQUEST1_1AND1_2
// End of code