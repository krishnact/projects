...
public class DCM_structure_base extends S_VCT_SubtableFactory.S_VCT_Subtable { // Concrete
    // type
    // is
    // DCM_structure
    ...
    public static class dcmData extends BinStruct implements PublicBinMsg {
        ...
        public int write(DataOutputStream ostream) throws IOException {
            ...
            // write bf5
            ostream.writeByte(bf5.getValue());
            retVal += 1;
            postWrite();
            return retVal;
        }
        ...
        public int dump(DumpContext dc) throws IOException {
            ...
            // write bf5
            {
                ...
                dc.getPs().println(
                    BitField_8.toDisplayString(getRange_defined(), 1));
                dc.indent();
                dc.getPs().print("channelsCount: ");
                dc.getPs().println(
                    BitField_8.toDisplayString(getChannelsCount(), 7));
            }
            dc.decreaseIndent();
            return retVal;
        }
        ...
        public void setRange_defined(int val) {
            bf5.setValue((bf5.getValue() & 0xffffff7f)
                         | ((val << 7) & 0x00000080));
        }
        ...
        public void setChannelsCount(int val) {
            bf5.setValue((bf5.getValue() & 0xffffff80)
                         | ((val << 0) & 0x0000007f));
        }
    ...
    private void init() {
        ...
        bf2 = new BitField_8();
        // Initialize dcmDatum
        dcmDatum = new ArrayList<dcmData>();
    ...
    public int write(DataOutputStream ostream) throws IOException {
        ...
        {
            /** fix dependent sizes for dcmDatum **/
            setDCM_data_length((short) dcmDatum.getSize());
        }
        ...
        // write dcmDatum
        {
            ArrayList<dcmData> temp1 = dcmDatum;
            for (int iIdx = 0; iIdx < temp1.getCount(); iIdx++) {
                dcmData temp2 = temp1.get(iIdx);
                if (temp2 != null)
    ...
    public int dump(DumpContext dc) throws IOException {
        ...
        // write bf1
        {
            ...
            dc.getPs().println(
                BitField_8.toDisplayString(getFirst_virtual_channel(), 12));
        }
        // write bf2
        {
            dc.indent();
            ...
            dc.getPs().println(
                BitField_8.toDisplayString(getDCM_data_length(), 7));
        }
        // write dcmDatum
        {
            ArrayList<dcmData> temp1 = dcmDatum;
            for (int iIdx = 0; iIdx < temp1.getCount(); iIdx++) {
                dcmData element = temp1.get(iIdx);
                dc.indent();
