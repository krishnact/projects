...
public  class DiagnosticCnf extends   APDUBaseFactory.APDUBase { //Concrete type is DiagnosticCnf
    ...
    public short length ;
    // numberOfDiag
    public ByteArray numberOfDiag ;

    public DiagnosticCnf () // throws Exception
    {
        init();
    }
    ...
    private void init()
    {
        ...
        // Initialize numberOfDiag
        numberOfDiag= new ByteArray();
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write numberOfDiag
        dc.indent();
        dc.getPs().print("numberOfDiag: "+numberOfDiag.getSize()+"(0x"+Integer.toHexString(numberOfDiag.getSize())+")\n");
        this.numberOfDiag.dump(dc);
        dc.decreaseIndent();
        return retVal;
    }
    ...
    //public ByteArray getNumberOfDiag()
    //{
    //    return numberOfDiag ;
    //}
    ...
    //public void setNumberOfDiag(ByteArray val)
    //{
    //    this.numberOfDiag= val;
    //}


    public void setNumberOfDiag(byte[] val)
    {
        this.numberOfDiag.setData(val);
    }
