...
public  class HostPropertiesReqMsg extends BinStruct implements PublicBinMsg{
    ...
    public ByteArray data ;
        ...
        public HostPropertiesReqMsg () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("HostPropertiesReqMsg\n");
    dc.increaseIndent();
        int retVal= 0;
        // write data
