...
public  class OpenSessionResponse extends BinStruct implements PublicBinMsg {
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        {
            resourceIdentifier=(long)(BinPrimitive.readUI32(istream) );
            retVal+=4;
        }
        // read sessionStatus
        {
            sessionStatus=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
        // read sessionNb
        {
            sessionNb=istream.readUnsignedShort();
            retVal+=2;
        }
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        BinPrimitive.writeUI32(ostream,resourceIdentifier);
        retVal +=4;
        // write sessionStatus
        ostream.writeByte(sessionStatus);
        retVal +=1;
        // write sessionNb
        ostream.writeShort(sessionNb);
        retVal +=2;
        postWrite();
        return retVal;
    }
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write resourceIdentifier
        dc.indent();
        dc.getPs().println("resourceIdentifier="+resourceIdentifier+"(0x"+ Long.toHexString(resourceIdentifier)+")") ;
        // write sessionStatus
        dc.indent();
        dc.getPs().println("sessionStatus="+sessionStatus+"(0x"+ Integer.toHexString(sessionStatus) + ")" );
        // write sessionNb
        dc.indent();
        dc.getPs().println("sessionNb="+sessionNb+"(0x"+ Integer.toHexString(sessionNb) + ")" );
        dc.decreaseIndent();
        return retVal;
    }
