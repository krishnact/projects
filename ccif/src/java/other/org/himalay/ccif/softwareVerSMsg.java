...
public  class softwareVerSMsg extends BinStruct implements PublicBinMsg{
    ...
    preRead();
        ...
        {applicationVersionNumber=istream.readUnsignedShort(); retVal+=2;}
        // read ApplicationStatusfield
        {ApplicationStatusfield=(short)(istream.readUnsignedByte()); retVal+=1;}
    ...
    preWrite();
        ...
        ostream.writeShort(applicationVersionNumber); retVal +=2;
        // write ApplicationStatusfield
        ostream.writeByte(ApplicationStatusfield); retVal +=1;
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("softwareVerSMsg\n");
    dc.increaseIndent();
        int retVal= 0;
        // write applicationVersionNumber
        dc.indent();dc.getPs().println("applicationVersionNumber="+applicationVersionNumber+"(0x"+ Integer.toHexString(applicationVersionNumber) + ")" );
        // write ApplicationStatusfield
        dc.indent();dc.getPs().println("ApplicationStatusfield="+ApplicationStatusfield+"(0x"+ Integer.toHexString(ApplicationStatusfield) + ")" );
        // write applicationNameByte
