...
public  class Language extends BinStruct implements PublicBinMsg {
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        // read lanuageControl
        {
            lanuageControl= BinPrimitive.readUI24(istream);
            retVal += 3;
        }
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        {
            ostream.writeByte((lanuageControl  & 0x00FF0000)>>16);
            ostream.writeShort((lanuageControl & 0x0000FFFF));
            retVal+=3;
        }
        postWrite();
        return retVal;
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write lanuageControl
        dc.indent();
        dc.getPs().println("lanuageControl="+lanuageControl+"(0x"+ Integer.toHexString(lanuageControl)+")") ;
        dc.decreaseIndent();
        return retVal;
    }
