...
public  class programCnfMsg extends BinStruct implements PublicBinMsg {
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        {
            purchaseValidation=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
        // read expirationdatee
        {
            expirationdatee=(long)(BinPrimitive.readUI32(istream) );
            retVal+=4;
        }
        // read ProgramStartTim
        {
            ProgramStartTim=(long)(BinPrimitive.readUI32(istream) );
            retVal+=4;
        }
        // read initialFreepreviewDuration
        {
            initialFreepreviewDuration=istream.readUnsignedShort();
            retVal+=2;
        }
        // read anyTimeFreepreviewDuration
        {
            anyTimeFreepreviewDuration=istream.readUnsignedShort();
            retVal+=2;
        }
        // read data
        {
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        ostream.writeByte(purchaseValidation);
        retVal +=1;
        // write expirationdatee
        BinPrimitive.writeUI32(ostream,expirationdatee);
        retVal +=4;
        // write ProgramStartTim
        BinPrimitive.writeUI32(ostream,ProgramStartTim);
        retVal +=4;
        // write initialFreepreviewDuration
        ostream.writeShort(initialFreepreviewDuration);
        retVal +=2;
        // write anyTimeFreepreviewDuration
        ostream.writeShort(anyTimeFreepreviewDuration);
        retVal +=2;
        // write data
        {
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write purchaseValidation
        dc.indent();
        dc.getPs().println("purchaseValidation="+purchaseValidation+"(0x"+ Integer.toHexString(purchaseValidation) + ")" );
        // write expirationdatee
        dc.indent();
        dc.getPs().println("expirationdatee="+expirationdatee+"(0x"+ Long.toHexString(expirationdatee)+")") ;
        // write ProgramStartTim
        dc.indent();
        dc.getPs().println("ProgramStartTim="+ProgramStartTim+"(0x"+ Long.toHexString(ProgramStartTim)+")") ;
        // write initialFreepreviewDuration
        dc.indent();
        dc.getPs().println("initialFreepreviewDuration="+initialFreepreviewDuration+"(0x"+ Integer.toHexString(initialFreepreviewDuration) + ")" );
        // write anyTimeFreepreviewDuration
        dc.indent();
        dc.getPs().println("anyTimeFreepreviewDuration="+anyTimeFreepreviewDuration+"(0x"+ Integer.toHexString(anyTimeFreepreviewDuration) + ")" );
        // write data
        dc.indent();
        ...
        // write data1
        dc.indent();
        dc.getPs().print("data1: "+data1.getSize()+"(0x"+Integer.toHexString(data1.getSize())+")\n");
        this.data1.dump(dc);
        // write descriptors
        {
            ArrayList<CaDescriptor> temp1 = descriptors;
