...
public  class CDS_Record extends BinStruct implements PublicBinMsg{
    ...
    preRead();
        ...
        {number_of_carriers=(short)(istream.readUnsignedByte()); retVal+=1;}
        // read bf1
    ...
    preWrite();
        ...
        ostream.writeByte(number_of_carriers); retVal +=1;
        // write bf1
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("CDS_Record\n");
    dc.increaseIndent();
        int retVal= 0;
        // write number_of_carriers
        dc.indent();dc.getPs().println("number_of_carriers="+number_of_carriers+"(0x"+ Integer.toHexString(number_of_carriers) + ")" );
        // write bf1
        {dc.indent();dc.getPs().print("spacingUnit: ");dc.getPs().println(BitField_8.toDisplayString(getSpacingUnit(),1));dc.indent();dc.getPs().print("frequencySpacing: ");dc.getPs().println(BitField_8.toDisplayString(getFrequencySpacing(),14));}
        // write bf2
        {dc.indent();dc.getPs().print("frequencyUnit: ");dc.getPs().println(BitField_8.toDisplayString(getFrequencyUnit(),1));dc.indent();dc.getPs().print("firstCarrierFrequency: ");dc.getPs().println(BitField_8.toDisplayString(getFirstCarrierFrequency(),15));}
dc.decreaseIndent();
        return retVal;
    }
