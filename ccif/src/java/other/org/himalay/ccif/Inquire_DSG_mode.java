...
public  class Inquire_DSG_mode extends   APDUBaseFactory.APDUBase { //Concrete type is Inquire_DSG_mode
    ...
    public short length ;
        ...
        public Inquire_DSG_mode () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("Inquire_DSG_mode\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
