...
@Created(date = "Thu Jan 28 21:09:51 EST 2016")
public class DNSQuery_v2 extends BinStruct implements PublicBinMsg {
  ...
  public DNSQuery_v2() // throws Exception
       {
    init();
  }
  ...
  public int write(DataOutputStream ostream) throws IOException {
    ...
    {
        /** fix dependent sizes for questions**/
      questions = (short) (questionsList.getCount() - (0));
    }
    {
    ...
    // write questions
    {
      ArrayList<Question> temp1 = questionsList;
      for (int iIdx = 0; iIdx < temp1.getCount(); iIdx++) {
        Question temp2 = temp1.get(iIdx);
  ...
  public int dump(DumpContext dc) throws IOException {
    ...
    // write questions
    {
      ArrayList<Question> temp1 = questionsList;
      for (int iIdx = 0; iIdx < temp1.getCount(); iIdx++) {
        Question element = temp1.get(iIdx);
        dc.indent();
  ...
  // Setter for questions
  //public void setQuestions(ArrayList<Question> val)
  //{
  //    this.questions= val;
  //}
  ...
  public int addToQuestions(Question val) {
	  questionsList.add(val);
    return questionsList.size();
  }

  public int removeFromQuestions(Question val) {
	  questionsList.remove(val);
    return questionsList.size();
  }

  public int removeNthFromQuestions(int idx) {
	  questionsList.remove(idx);
    return questionsList.size();
  }

  public int emptyQuestions(int idx) {
	  questionsList.clear();
    return questionsList.size();
  }
