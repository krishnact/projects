...
public  class longform_virtual_channel_table_section_ extends   SCTE65TableFactory.SCTE65Table { //Concrete type is longform_virtual_channel_table_section
...
longform_virtual_channel_table_section_ parent;
    public record (longform_virtual_channel_table_section_ parent) // throws Exception
    {
        this.parent= parent;
            init();
    }
    ...
    private void init()
    {
        ...
        short_name= new ByteArray();short_name.setSizeType("FIXED");short_name.setSize(14);
        // Initialize bf1
        bf1 = new BitField_32();
        ...
        descriptors= new ArrayList<SCTE65DescriptorFactory.SCTE65Descriptor>();descriptors.setMemberSize(0);
    }
    ...
    preRead();
        ...
        {carrierFrequency=(long)(BinPrimitive.readUI32(istream) ); retVal+=4;}
        // read channelTSID
        {channelTSID=istream.readUnsignedShort(); retVal+=2;}
        // read programNumber
        {programNumber=istream.readUnsignedShort(); retVal+=2;}
        // read bf2
        retVal += bf2.read(istream);
        // read sourceType
        {sourceType=istream.readUnsignedShort(); retVal+=2;}
        // read bf3
        retVal += bf3.read(istream);
        // read descriptors
        for (int iIdx=0; iIdx <getDescriptorsLength() + (0); iIdx++){     SCTE65DescriptorFactory.SCTE65Descriptor temp;    /* Generic classes are abstract, so we can not invoke new*/    {IntegerHolder iHolder= new IntegerHolder();DataInputStream disTemp = istream;temp=SCTE65DescriptorFactory.createMsg(disTemp,iHolder); retVal+= iHolder.getValue();        }    descriptors.add(temp);}
    ...
    preWrite();
        ...
        { /** fix dependent sizes for descriptors**/ setDescriptorsLength((short)descriptors.getCount()); }
        ...
        BinPrimitive.writeUI32(ostream,carrierFrequency); retVal +=4;
        // write channelTSID
        ostream.writeShort(channelTSID); retVal +=2;
        // write programNumber
        ostream.writeShort(programNumber); retVal +=2;
        // write bf2
        ostream.writeShort(bf2.getValue()); retVal +=2;
        // write sourceType
        ostream.writeShort(sourceType); retVal +=2;
        // write bf3
        ostream.writeShort(bf3.getValue()); retVal +=2;
        // write descriptors
        {ArrayList<SCTE65DescriptorFactory.SCTE65Descriptor> temp1 = descriptors;for (int iIdx=0; iIdx < temp1.getCount() ; iIdx++){     SCTE65DescriptorFactory.SCTE65Descriptor temp2    =    temp1.get(iIdx);    if (temp2!=null)retVal +=temp2.write(ostream);}}
postWrite();
        return retVal;
    }
    ...
    dc.increaseIndent();
        int retVal= 0;
        // write short_name
        dc.indent();dc.getPs().print("short_name: "+short_name.getSize()+"(0x"+Integer.toHexString(short_name.getSize())+")\n");this.short_name.dump(dc);
        // write bf1
        {dc.indent();dc.getPs().print("reserved_: ");dc.getPs().println(BitField_8.toDisplayString(getReserved_(),4));dc.indent();dc.getPs().print("majorChannelNumber: ");dc.getPs().println(BitField_8.toDisplayString(getMajorChannelNumber(),10));dc.indent();dc.getPs().print("minorChannelNumber: ");dc.getPs().println(BitField_8.toDisplayString(getMinorChannelNumber(),10));dc.indent();dc.getPs().print("modulationMode: ");dc.getPs().println(BitField_8.toDisplayString(getModulationMode(),8));}
        // write carrierFrequency
        dc.indent();dc.getPs().println("carrierFrequency="+carrierFrequency+"(0x"+ Long.toHexString(carrierFrequency)+")") ;
        // write channelTSID
        dc.indent();dc.getPs().println("channelTSID="+channelTSID+"(0x"+ Integer.toHexString(channelTSID) + ")" );
        // write programNumber
        dc.indent();dc.getPs().println("programNumber="+programNumber+"(0x"+ Integer.toHexString(programNumber) + ")" );
        // write bf2
        {dc.indent();dc.getPs().print("reserved2_: ");dc.getPs().println(BitField_8.toDisplayString(getReserved2_(),2));dc.indent();dc.getPs().print("accessControlled: ");dc.getPs().println(BitField_8.toDisplayString(getAccessControlled(),1));dc.indent();dc.getPs().print("hidden: ");dc.getPs().println(BitField_8.toDisplayString(getHidden(),1));dc.indent();dc.getPs().print("pathSelect: ");dc.getPs().println(BitField_8.toDisplayString(getPathSelect(),1));dc.indent();dc.getPs().print("outOfBand: ");dc.getPs().println(BitField_8.toDisplayString(getOutOfBand(),1));dc.indent();dc.getPs().print("hideGuide: ");dc.getPs().println(BitField_8.toDisplayString(getHideGuide(),1));dc.indent();dc.getPs().print("reserved3_: ");dc.getPs().println(BitField_8.toDisplayString(getReserved3_(),3));dc.indent();dc.getPs().print("serviceType: ");dc.getPs().println(BitField_8.toDisplayString(getServiceType(),6));}
        // write sourceType
        dc.indent();dc.getPs().println("sourceType="+sourceType+"(0x"+ Integer.toHexString(sourceType) + ")" );
        // write bf3
        {dc.indent();dc.getPs().print("reserved4_: ");dc.getPs().println(BitField_8.toDisplayString(getReserved4_(),6));dc.indent();dc.getPs().print("descriptorsLength: ");dc.getPs().println(BitField_8.toDisplayString(getDescriptorsLength(),10));}
        // write descriptors
        { ArrayList<SCTE65DescriptorFactory.SCTE65Descriptor> temp1 = descriptors;for (int iIdx=0; iIdx < temp1.getCount() ; iIdx++){     SCTE65DescriptorFactory.SCTE65Descriptor element    = temp1.get(iIdx); dc.indent(); dc.getPs().println(iIdx);    if ( element != null ) {dc.indent();dc.getPs().println("element") ;retVal +=element.dump(dc);}}}
dc.decreaseIndent();
        return retVal;
    }
    ...
    {
        bf1.setValue ( (bf1.getValue() & 0x0fffffff) | ( (val << 28 ) & 0xf0000000));
    }
    ...
    {
        bf1.setValue ( (bf1.getValue() & 0xf003ffff) | ( (val << 18 ) & 0x0ffc0000));
    }
    ...
    {
        bf1.setValue ( (bf1.getValue() & 0xfffc00ff) | ( (val << 8 ) & 0x0003ff00));
    }
    ...
    {
        bf1.setValue ( (bf1.getValue() & 0xffffff00) | ( (val << 0 ) & 0x000000ff));
    }
    ...
    {
        bf2.setValue ( (bf2.getValue() & 0xffff3fff) | ( (val << 14 ) & 0x0000c000));
    }
    ...
    {
        bf2.setValue ( (bf2.getValue() & 0xffffdfff) | ( (val << 13 ) & 0x00002000));
    }
    ...
    {
        bf2.setValue ( (bf2.getValue() & 0xffffefff) | ( (val << 12 ) & 0x00001000));
    }
    ...
    {
        bf2.setValue ( (bf2.getValue() & 0xfffff7ff) | ( (val << 11 ) & 0x00000800));
    }
    ...
    {
        bf2.setValue ( (bf2.getValue() & 0xfffffbff) | ( (val << 10 ) & 0x00000400));
    }
    ...
    {
        bf2.setValue ( (bf2.getValue() & 0xfffffdff) | ( (val << 9 ) & 0x00000200));
    }
    ...
    {
        bf2.setValue ( (bf2.getValue() & 0xfffffe3f) | ( (val << 6 ) & 0x000001c0));
    }
    ...
    {
        bf2.setValue ( (bf2.getValue() & 0xffffffc0) | ( (val << 0 ) & 0x0000003f));
    }
    ...
    {
        bf3.setValue ( (bf3.getValue() & 0xffff03ff) | ( (val << 10 ) & 0x0000fc00));
    }
    ...
    {
        bf3.setValue ( (bf3.getValue() & 0xfffffc00) | ( (val << 0 ) & 0x000003ff));
    }
    ...
    public int removeFromDescriptors(SCTE65DescriptorFactory.SCTE65Descriptor val)
    {
...
// End of code
  ...
  preRead();
    int retVal= 0;
                // read mapId
        {mapId=istream.readUnsignedShort(); retVal+=2;}
        // read bf3
        retVal += bf3.read(istream);
        // read section_number
        ...
        {protocol_version=(short)(istream.readUnsignedByte()); retVal+=1;}
        // read num_channel_in_section
        {num_channel_in_section=(short)(istream.readUnsignedByte()); retVal+=1;}
        // read records
        for (int iIdx=0; iIdx <num_channel_in_section + (0); iIdx++){     record temp;    temp = new record(this);    retVal += temp.read(istream);    records.add(temp);}
        // read bf4
        retVal += bf4.read(istream);
        // read descriptors
        for (int iIdx=0; iIdx <getAdditionalDescriptorsLength() + (0); iIdx++){     SCTE65DescriptorFactory.SCTE65Descriptor temp;    /* Generic classes are abstract, so we can not invoke new*/    {IntegerHolder iHolder= new IntegerHolder();DataInputStream disTemp = istream;temp=SCTE65DescriptorFactory.createMsg(disTemp,iHolder); retVal+= iHolder.getValue();        }    descriptors.add(temp);}
        // read CRC
...
postRead();
    ...
    preWrite();
        ...
        { /** fix dependent sizes for records**/ num_channel_in_section=((short)records.getCount()); }
        
        { /** fix dependent sizes for descriptors**/ setAdditionalDescriptorsLength((short)descriptors.getCount()); }
        
    
                // write tableHeader
        if (tableHeader!=null)retVal +=tableHeader.write(ostream);
        // write mapId
        ostream.writeShort(mapId); retVal +=2;
        // write bf3
        ...
        ostream.writeByte(protocol_version); retVal +=1;
        // write num_channel_in_section
        ostream.writeByte(num_channel_in_section); retVal +=1;
        // write records
...
postWrite();
    ...
    public int dump(DumpContext dc) throws IOException 
    {
        dc.indent();dc.getPs().print("longform_virtual_channel_table_section_\n");
    dc.increaseIndent();
        int retVal= 0;
        // write tableHeader
        if ( tableHeader != null ) {dc.indent();dc.getPs().println("tableHeader") ;retVal +=tableHeader.dump(dc);}
        // write mapId
        dc.indent();dc.getPs().println("mapId="+mapId+"(0x"+ Integer.toHexString(mapId) + ")" );
        // write bf3
        ...
        // write protocol_version
        dc.indent();dc.getPs().println("protocol_version="+protocol_version+"(0x"+ Integer.toHexString(protocol_version) + ")" );
        // write num_channel_in_section
        dc.indent();dc.getPs().println("num_channel_in_section="+num_channel_in_section+"(0x"+ Integer.toHexString(num_channel_in_section) + ")" );
        // write records
        ...
        // write bf4
        {dc.indent();dc.getPs().print("reserved4_: ");dc.getPs().println(BitField_8.toDisplayString(getReserved4_(),6));dc.indent();dc.getPs().print("additionalDescriptorsLength: ");dc.getPs().println(BitField_8.toDisplayString(getAdditionalDescriptorsLength(),10));}
        // write descriptors
        { ArrayList<SCTE65DescriptorFactory.SCTE65Descriptor> temp1 = descriptors;for (int iIdx=0; iIdx < temp1.getCount() ; iIdx++){     SCTE65DescriptorFactory.SCTE65Descriptor element    = temp1.get(iIdx); dc.indent(); dc.getPs().println(iIdx);    if ( element != null ) {dc.indent();dc.getPs().println("element") ;retVal +=element.dump(dc);}}}
        // write CRC
