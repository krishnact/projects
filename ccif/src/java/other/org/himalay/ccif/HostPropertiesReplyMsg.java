...
public  class HostPropertiesReplyMsg extends BinStruct implements PublicBinMsg{
    ...
    private void init()
    {
        ...
        propertyKeyByte= new ByteArray();propertyKeyByte.setSizeType("FIRST_UI8");
        // Initialize propertyValueByte
        propertyValueByte= new ByteArray();propertyValueByte.setSizeType("FIRST_UI8");
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("HostPropertiesReplyMsg\n");
    dc.increaseIndent();
        int retVal= 0;
        // write propertyKeyByte
        dc.indent();dc.getPs().print("propertyKeyByte: "+propertyKeyByte.getSize()+"(0x"+Integer.toHexString(propertyKeyByte.getSize())+")\n");this.propertyKeyByte.dump(dc);
        // write propertyValueByte
        dc.indent();dc.getPs().print("propertyValueByte: "+propertyValueByte.getSize()+"(0x"+Integer.toHexString(propertyValueByte.getSize())+")\n");this.propertyValueByte.dump(dc);
dc.decreaseIndent();
        return retVal;
    }
