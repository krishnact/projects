...
public  class SoftwareVerReportS_Mode extends BinStruct implements PublicBinMsg {
    ...
    private void init()
    {
        ...
        applicationsInReport= new ArrayList<softwareVerSMsg>();
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        for (; istream.available() > 0 ; ) {
            softwareVerSMsg temp;
            temp = new softwareVerSMsg();
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        {
            ArrayList<softwareVerSMsg> temp1 = applicationsInReport;
            for (int iIdx=0; iIdx < temp1.getCount() ; iIdx++) {
                softwareVerSMsg temp2    =    temp1.get(iIdx);
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write applicationsInReport
        {
            ArrayList<softwareVerSMsg> temp1 = applicationsInReport;
            for (int iIdx=0; iIdx < temp1.getCount() ; iIdx++) {
                softwareVerSMsg element    = temp1.get(iIdx);
                dc.indent();
