...
public  class diagnosticReqSmodeCnf extends   APDUBase_1Factory.APDUBase_1 { //Concrete type is diagnosticReqSmodeCnf
    ...
    public ByteArray selfDiagnostics ;
        ...
        public diagnosticReqSmodeCnf () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("diagnosticReqSmodeCnf\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
