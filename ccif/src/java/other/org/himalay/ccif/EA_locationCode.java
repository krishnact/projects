...
public  class EA_locationCode extends BinStruct implements PublicBinMsg {
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        // read stateCode
        {
            stateCode=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
        // read bf1
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write stateCode
        dc.indent();
        dc.getPs().println("stateCode="+stateCode+"(0x"+ Integer.toHexString(stateCode) + ")" );
        // write bf1
        {
            dc.indent();
            dc.getPs().print("countySubdivision: ");
            dc.getPs().println(BitField_8.toDisplayString(getCountySubdivision(),4));
            dc.indent();
            dc.getPs().print("reserved: ");
            dc.getPs().println(BitField_8.toDisplayString(getReserved(),2));
            dc.indent();
            dc.getPs().print("countyCode: ");
            dc.getPs().println(BitField_8.toDisplayString(getCountyCode(),11));
        }
        dc.decreaseIndent();
        return retVal;
    }
