...
public  class hostResetVectorAck extends   APDUBaseFactory.APDUBase { //Concrete type is hostResetVectorAck
    ...
    public short transaction_id ;
        ...
        public hostResetVectorAck () // throws Exception
    {
            init();
    }
  ...
  preRead();
    int retVal= 0;
        ...
        // read transaction_id
        {transaction_id=(short)(istream.readUnsignedByte()); retVal+=1;}
...
postRead();
    ...
    preWrite();
        ...
        ostream.writeByte(transaction_id); retVal +=1;
postWrite();
        return retVal;
    }
    ...
    {
        dc.indent();dc.getPs().print("hostResetVectorAck\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
        ...
        // write transaction_id
        dc.indent();dc.getPs().println("transaction_id="+transaction_id+"(0x"+ Integer.toHexString(transaction_id) + ")" );
dc.decreaseIndent();
        return retVal;
    }
