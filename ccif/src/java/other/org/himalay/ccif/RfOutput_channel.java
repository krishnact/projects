...
public  class RfOutput_channel extends BinStruct implements PublicBinMsg {
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        // read outputChannel
        {
            outputChannel=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
        // read outputChannelUi
        {
            outputChannelUi=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        // write outputChannel
        ostream.writeByte(outputChannel);
        retVal +=1;
        // write outputChannelUi
        ostream.writeByte(outputChannelUi);
        retVal +=1;
        postWrite();
        return retVal;
    }
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write outputChannel
        dc.indent();
        dc.getPs().println("outputChannel="+outputChannel+"(0x"+ Integer.toHexString(outputChannel) + ")" );
        // write outputChannelUi
        dc.indent();
        dc.getPs().println("outputChannelUi="+outputChannelUi+"(0x"+ Integer.toHexString(outputChannelUi) + ")" );
        dc.decreaseIndent();
        return retVal;
    }
