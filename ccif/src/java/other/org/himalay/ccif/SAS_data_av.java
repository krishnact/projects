...
public  class SAS_data_av extends   APDUBaseFactory.APDUBase { //Concrete type is SAS_data_av
    ...
    public int readNoHeader(DataInputStream istream) throws IOException
    {
        ...
        // read SAS_dataStatus
        {
            SAS_dataStatus=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
        // read transaction_nb
        {
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        ostream.writeByte(SAS_dataStatus);
        retVal +=1;
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write SAS_dataStatus
        dc.indent();
        dc.getPs().println("SAS_dataStatus="+SAS_dataStatus+"(0x"+ Integer.toHexString(SAS_dataStatus) + ")" );
        // write transaction_nb
        dc.indent();
