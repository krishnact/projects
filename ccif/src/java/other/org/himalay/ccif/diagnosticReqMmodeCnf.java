...
public  class diagnosticReqMmodeCnf extends   APDUBase_2Factory.APDUBase_2 { //Concrete type is diagnosticReqMmodeCnf
    ...
    public ByteArray selfDiagnostics ;
        ...
        public diagnosticReqMmodeCnf () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("diagnosticReqMmodeCnf\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
