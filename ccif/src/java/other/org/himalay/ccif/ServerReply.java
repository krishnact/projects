...
public  class ServerReply extends   APDUBaseFactory.APDUBase { //Concrete type is ServerReply
  ...
  preRead();
    int retVal= 0;
        ...
        // read fileStatus
        {fileStatus=(short)(istream.readUnsignedByte()); retVal+=1;}
        // read headerFileName
...
postRead();
    ...
    preWrite();
        ...
        // write fileStatus
        ostream.writeByte(fileStatus); retVal +=1;
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("ServerReply\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
        ...
        // write fileStatus
        dc.indent();dc.getPs().println("fileStatus="+fileStatus+"(0x"+ Integer.toHexString(fileStatus) + ")" );
        // write headerFileName
