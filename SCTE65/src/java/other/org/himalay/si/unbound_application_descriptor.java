...
public class unbound_application_descriptor
    extends
    ...
    public int readNoHeader(DataInputStream istream) throws IOException {
        ...
        // read version_number
        {
            version_number = (long) (BinPrimitive.readUI32(istream));
            retVal += 4;
        }
    ...
    public int write(DataOutputStream ostream) throws IOException {
        ...
        BinPrimitive.writeUI32(ostream, version_number);
        retVal += 4;
        postWrite();
        return retVal;
    }
    ...
    public int dump(DumpContext dc) throws IOException {
        ...
        dc.indent();
        dc.getPs().println(
            "service_id=" + service_id + "(0x"
            + Integer.toHexString(service_id) + ")");
        // write version_number
        dc.indent();
        dc.getPs().println(
            "version_number=" + version_number + "(0x"
            + Long.toHexString(version_number) + ")");
        dc.decreaseIndent();
        return retVal;
    }
