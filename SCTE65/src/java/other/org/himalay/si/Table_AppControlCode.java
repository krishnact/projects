...
public class Table_AppControlCode extends Table
{
    static Hashtable<Range, Row> rowsMap= new Hashtable<Table.Range, Table.Row>(); 
    static
{
rowsMap.put(new Range(0,0), new Row("AutoStart",""));
rowsMap.put(new Range(1,1), new Row("AutoLaunch",""));
rowsMap.put(new Range(2,15), new Row("Reserved",""));
}
