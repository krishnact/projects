...
//    long    references;
    ...
    public:
        ...
        // object_data ---
    public:
        org_himalay_msgs_runtime_ByteArray_PTR_TYPE object_data; ;
        // code_file_name ---
    public:
...
public:
    ...
    // number_of_objects ---
public:
    ui8 number_of_objects ;
    // pv2Datum ---
public:
    ArrayList(PV2::PV2Object) pv2Datum ;


public:
    PV2 (); // throws Exception
    virtual ~PV2 ();
public:
    int readNoHeader(DataInputStream& istream);// throws IOException
