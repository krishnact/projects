...
public  class DescriptorCollection extends BinStruct implements PublicBinMsg{
    ...
    preWrite();
        ...
        { /** fix dependent sizes for descriptors**/ descriptor_count=((short)descriptors.getCount()); }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("DescriptorCollection\n");
    dc.increaseIndent();
        int retVal= 0;
        // write descriptor_count
