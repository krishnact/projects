...
public class MpegPrivateDataBytes extends BinStruct implements PublicBinMsg {

	// members variables
	// data
	public ByteArray data;

	public MpegPrivateDataBytes() // throws Exception
	{
		init();
	}
	...
	public int dump(DumpContext dc) throws IOException {
		dc.indent();
		dc.getPs().print("MpegPrivateDataBytes\n");
		dc.increaseIndent();
		int retVal = 0;
		// write data
		dc.indent();
