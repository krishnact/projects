...
public  class AudioFormat extends BinStruct implements PublicBinMsg {
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write bf1
        {
            ...
            dc.getPs().println(BitField_8.toDisplayString(getAudioSampleSize(),2));
            dc.indent();
            dc.getPs().print("audioFormat: ");
            dc.getPs().println(BitField_8.toDisplayString(getAudioFormat(),3));
            dc.indent();
            dc.getPs().print("audioSamplefreq: ");
            dc.getPs().println(BitField_8.toDisplayString(getAudioSamplefreq(),3));
        }
        dc.decreaseIndent();
        return retVal;
    }
