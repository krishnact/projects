...
public  class Eui64 extends BinStruct implements PublicBinMsg{
    ...
    {
        // Initialize data
        data= new ByteArray();data.setSizeType("FIXED");data.setSize(8);
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("Eui64\n");
    dc.increaseIndent();
        int retVal= 0;
        // write data
