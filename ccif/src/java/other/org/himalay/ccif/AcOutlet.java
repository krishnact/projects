...
public  class AcOutlet extends BinStruct implements PublicBinMsg {
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        {
            acOutletControl=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        ostream.writeByte(acOutletControl);
        retVal +=1;
        postWrite();
        return retVal;
    }
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write acOutletControl
        dc.indent();
        dc.getPs().println("acOutletControl="+acOutletControl+"(0x"+ Integer.toHexString(acOutletControl) + ")" );
        dc.decreaseIndent();
        return retVal;
    }
