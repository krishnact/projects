...
public  class GetRootOidReq extends   APDUBaseFactory.APDUBase { //Concrete type is GetRootOidReq
    ...
    public short length ;
        ...
        public GetRootOidReq () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("GetRootOidReq\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
