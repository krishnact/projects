...
public  class HomingActive extends   APDUBaseFactory.APDUBase { //Concrete type is HomingActive
    ...
    public short length ;
        ...
        public HomingActive () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("HomingActive\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
