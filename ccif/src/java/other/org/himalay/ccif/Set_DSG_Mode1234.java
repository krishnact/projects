...
Set_DSG_Mode1234 parent;
    ...
    preRead();
        ...
        {remove_header_bytes=istream.readUnsignedShort(); retVal+=2;}
    ...
    preWrite();
        ...
        ostream.writeShort(remove_header_bytes); retVal +=2;
postWrite();
        return retVal;
    }
    ...
    dc.increaseIndent();
        ...
        // write remove_header_bytes
        dc.indent();dc.getPs().println("remove_header_bytes="+remove_header_bytes+"(0x"+ Integer.toHexString(remove_header_bytes) + ")" );
dc.decreaseIndent();
        return retVal;
    }
...
// End of code
  ...
  preRead();
    int retVal= 0;
        ...
        {operationalMode=(short)(istream.readUnsignedByte()); retVal+=1;}
        // read StatusfieldCheckInstance
        if ((operationalMode == 0x03) ||                (operationalMode ==0x04)){ StatusfieldCheckInstance = new StatusfieldCheck(this);retVal += StatusfieldCheckInstance.read(istream);        }
...
postRead();
    ...
    preWrite();
        ...
        ostream.writeByte(operationalMode); retVal +=1;
...
postWrite();
    ...
    public int dump(DumpContext dc) throws IOException 
    {
        dc.indent();dc.getPs().print("Set_DSG_Mode1234\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
        ...
        // write operationalMode
        dc.indent();dc.getPs().println("operationalMode="+operationalMode+"(0x"+ Integer.toHexString(operationalMode) + ")" );
        // write StatusfieldCheckInstance
