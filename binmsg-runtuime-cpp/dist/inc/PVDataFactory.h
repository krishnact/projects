...
class PVDataFactory { 
    ...
    public: class PVData : public BinMessage {
    public: PVData();
    public: virtual ~PVData();
...
//public: static  PVData* lastParsedObject;
    public: static org_himalay_cl_cdl_PVDataFactory_PVData__PTR_TYPE createMsg( int messageType, DataInputStream& dis, int& iHolder) throw(IOException);
