...
public  class Inquire_DSG_Mode1234 extends   APDUBaseFactory.APDUBase { //Concrete type is Inquire_DSG_Mode1234
    ...
    public short length ;
        ...
        public Inquire_DSG_Mode1234 () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("Inquire_DSG_Mode1234\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
