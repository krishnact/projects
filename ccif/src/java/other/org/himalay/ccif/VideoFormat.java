...
public  class VideoFormat extends BinStruct implements PublicBinMsg {
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        // read horizontalLine
        {
            horizontalLine=istream.readUnsignedShort();
            retVal+=2;
        }
        // read verticalline
        {
            verticalline=istream.readUnsignedShort();
            retVal+=2;
        }
        // read frameRate
        {
            frameRate=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
        // read bf1
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        ostream.writeShort(horizontalLine);
        retVal +=2;
        // write verticalline
        ostream.writeShort(verticalline);
        retVal +=2;
        // write frameRate
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write horizontalLine
        dc.indent();
        dc.getPs().println("horizontalLine="+horizontalLine+"(0x"+ Integer.toHexString(horizontalLine) + ")" );
        // write verticalline
        dc.indent();
        dc.getPs().println("verticalline="+verticalline+"(0x"+ Integer.toHexString(verticalline) + ")" );
        // write frameRate
        dc.indent();
        dc.getPs().println("frameRate="+frameRate+"(0x"+ Integer.toHexString(frameRate) + ")" );
        // write bf1
        {
            dc.indent();
            dc.getPs().print("aspectRatio: ");
            dc.getPs().println(BitField_8.toDisplayString(getAspectRatio(),2));
            dc.indent();
            dc.getPs().print("progInterType: ");
            dc.getPs().println(BitField_8.toDisplayString(getProgInterType(),1));
            dc.indent();
