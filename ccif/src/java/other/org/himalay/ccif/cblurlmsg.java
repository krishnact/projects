...
public  class cblurlmsg extends BinStruct implements PublicBinMsg{
    ...
    private void init()
    {
        ...
        // Initialize urlchars
        urlchars= new ByteArray();urlchars.setSizeType("FIRST_UI8");
    }
    ...
    preRead();
        int retVal= 0;
                     ...
                     // read urlType
        {urlType=(short)(istream.readUnsignedByte()); retVal+=1;}
        // read urlchars
    ...
    preWrite();
        ...
        { /** fix dependent sizes for urlchars**/  }
                ...
                // write urlType
        ostream.writeByte(urlType); retVal +=1;
        // write urlchars
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("cblurlmsg\n");
    dc.increaseIndent();
        int retVal= 0;
        // write urlType
        dc.indent();dc.getPs().println("urlType="+urlType+"(0x"+ Integer.toHexString(urlType) + ")" );
        // write urlchars
        dc.indent();dc.getPs().print("urlchars: "+urlchars.getSize()+"(0x"+Integer.toHexString(urlchars.getSize())+")\n");this.urlchars.dump(dc);
dc.decreaseIndent();
        return retVal;
    }
