...
DaylightSavings_1_2 parent;
    ...
    preRead();
        ...
        {daylight_savings_delta=(short)(istream.readUnsignedByte()); retVal+=1;}
        // read daylightSavingsEntryTime
        {daylightSavingsEntryTime=(long)(BinPrimitive.readUI32(istream) ); retVal+=4;}
        // read daylightSavingsExitTime
        {daylightSavingsExitTime=(long)(BinPrimitive.readUI32(istream) ); retVal+=4;}
    ...
    preWrite();
        ...
        ostream.writeByte(daylight_savings_delta); retVal +=1;
        // write daylightSavingsEntryTime
        BinPrimitive.writeUI32(ostream,daylightSavingsEntryTime); retVal +=4;
        // write daylightSavingsExitTime
        BinPrimitive.writeUI32(ostream,daylightSavingsExitTime); retVal +=4;
postWrite();
        return retVal;
    }
    ...
    {
        dc.indent();dc.getPs().print("daylightSaving\n");
    dc.increaseIndent();
        int retVal= 0;
        // write daylight_savings_delta
        dc.indent();dc.getPs().println("daylight_savings_delta="+daylight_savings_delta+"(0x"+ Integer.toHexString(daylight_savings_delta) + ")" );
        // write daylightSavingsEntryTime
        dc.indent();dc.getPs().println("daylightSavingsEntryTime="+daylightSavingsEntryTime+"(0x"+ Long.toHexString(daylightSavingsEntryTime)+")") ;
        // write daylightSavingsExitTime
        dc.indent();dc.getPs().println("daylightSavingsExitTime="+daylightSavingsExitTime+"(0x"+ Long.toHexString(daylightSavingsExitTime)+")") ;
dc.decreaseIndent();
        return retVal;
    }
...
// End of code
    ...
    preRead();
        ...
        if (daylightSavingsControl==0x02){ daylightSavingInstance = new daylightSaving(this);retVal += daylightSavingInstance.read(istream);        }
...
postWrite();
    ...
    public int dump(DumpContext dc) throws IOException 
    {
        dc.indent();dc.getPs().print("DaylightSavings_1_2\n");
    dc.increaseIndent();
        int retVal= 0;
        // write daylightSavingsControl
        dc.indent();dc.getPs().println("daylightSavingsControl="+daylightSavingsControl+"(0x"+ Integer.toHexString(daylightSavingsControl) + ")" );
        // write daylightSavingInstance
        if ( daylightSavingInstance != null ) {dc.indent();dc.getPs().println("daylightSavingInstance") ;retVal +=daylightSavingInstance.dump(dc);}
dc.decreaseIndent();
        return retVal;
    }
