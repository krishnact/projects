...
public  class HomingCancelled extends   APDUBaseFactory.APDUBase { //Concrete type is HomingCancelled
    ...
    public short length ;
        ...
        public HomingCancelled () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("HomingCancelled\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
