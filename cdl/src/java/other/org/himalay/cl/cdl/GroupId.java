...
public  class GroupId extends   ResourceFactory.Resource { //Concrete type is GroupId
    ...
    public ByteArray id ;
        ...
        public GroupId () // throws Exception
    {
            init();
    }
    ...
    private void init()
    {
        ...
        // Initialize id
        id= new ByteArray();id.setSizeType("FIXED");id.setSize(2);
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("GroupId\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
