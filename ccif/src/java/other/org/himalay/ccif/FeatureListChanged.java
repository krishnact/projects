...
public  class FeatureListChanged extends   APDUBaseFactory.APDUBase { //Concrete type is FeatureListChanged
    ...
    public short length ;
        ...
        public FeatureListChanged () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("FeatureListChanged\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
