...
public:
    class LocationType : public BinMessage {
    public:
        LocationType();
    public:
...
public:
    static org_himalay_cl_cdl_LocationTypeFactory_LocationType__PTR_TYPE createMsg( int messageType, DataInputStream& dis, int& iHolder) throw(IOException);
