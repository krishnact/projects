#ifndef ORG_HIMALAY_CCIF_CODEVERSIONTABLE1_3
#define ORG_HIMALAY_CCIF_CODEVERSIONTABLE1_3
 ...
 */
#define org_himalay_ccif_codeVersionTable1_3__USE_SMART_PTR
#ifdef org_himalay_ccif_codeVersionTable1_3__USE_SMART_PTR
#include "boost/shared_ptr.hpp"
#define org_himalay_ccif_codeVersionTable1_3__PTR_TYPE boost::shared_ptr<codeVersionTable1_3>
#define org_himalay_ccif_codeVersionTable1_3__NEW(x) {/** Serious **/x = org_himalay_ccif_codeVersionTable1_3__PTR_TYPE(new codeVersionTable1_3()); }
#define org_himalay_ccif_codeVersionTable1_3__INIT(x)
#define org_himalay_ccif_codeVersionTable1_3__DELETE(x)
#else
#define org_himalay_ccif_codeVersionTable1_3__PTR_TYPE codeVersionTable1_3*
#define org_himalay_ccif_codeVersionTable1_3__NEW(x) {x= new codeVersionTable1_3();}
#define org_himalay_ccif_codeVersionTable1_3__INIT(x)  x=NULL;
#define org_himalay_ccif_codeVersionTable1_3__DELETE(x)  {delete(x);x=NULL;}
#endif
...
#ifdef org_himalay_ccif_codeVersionTable1_3__USE_SMART_PTR
#include "boost/shared_ptr.hpp"
#define org_himalay_ccif_codeVersionTable1_3_statusfld__PTR_TYPE boost::shared_ptr<codeVersionTable1_3::statusfld>
//#define org_himalay_ccif_codeVersionTable1_3_statusfld__NEW(x) {x =new codeVersionTable1_3::statusfld();}
#define org_himalay_ccif_codeVersionTable1_3_statusfld__NEW(x) {/** Serious **/x = org_himalay_ccif_codeVersionTable1_3_statusfld__PTR_TYPE(new codeVersionTable1_3::statusfld()); }
#define org_himalay_ccif_codeVersionTable1_3_statusfld__INIT(x)
#define org_himalay_ccif_codeVersionTable1_3_statusfld__DELETE(x)
#else
#define org_himalay_ccif_codeVersionTable1_3_statusfld__PTR_TYPE codeVersionTable1_3::statusfld*
#define org_himalay_ccif_codeVersionTable1_3_statusfld__NEW(x) {x= new codeVersionTable1_3::statusfld();}
#define org_himalay_ccif_codeVersionTable1_3_statusfld__INIT(x)  x=NULL;
#define org_himalay_ccif_codeVersionTable1_3_statusfld__DELETE(x)  {delete(x);x=NULL;}
#endif


#ifdef org_himalay_ccif_codeVersionTable1_3__USE_SMART_PTR
#include "boost/shared_ptr.hpp"
#define org_himalay_ccif_codeVersionTable1_3_statusfld2__PTR_TYPE boost::shared_ptr<codeVersionTable1_3::statusfld2>
//#define org_himalay_ccif_codeVersionTable1_3_statusfld2__NEW(x) {x =new codeVersionTable1_3::statusfld2();}
#define org_himalay_ccif_codeVersionTable1_3_statusfld2__NEW(x) {/** Serious **/x = org_himalay_ccif_codeVersionTable1_3_statusfld2__PTR_TYPE(new codeVersionTable1_3::statusfld2()); }
#define org_himalay_ccif_codeVersionTable1_3_statusfld2__INIT(x)
#define org_himalay_ccif_codeVersionTable1_3_statusfld2__DELETE(x)
#else
#define org_himalay_ccif_codeVersionTable1_3_statusfld2__PTR_TYPE codeVersionTable1_3::statusfld2*
#define org_himalay_ccif_codeVersionTable1_3_statusfld2__NEW(x) {x= new codeVersionTable1_3::statusfld2();}
#define org_himalay_ccif_codeVersionTable1_3_statusfld2__INIT(x)  x=NULL;
#define org_himalay_ccif_codeVersionTable1_3_statusfld2__DELETE(x)  {delete(x);x=NULL;}
#endif


#ifdef org_himalay_ccif_codeVersionTable1_3__USE_SMART_PTR
#include "boost/shared_ptr.hpp"
#define org_himalay_ccif_codeVersionTable1_3_statusfld3__PTR_TYPE boost::shared_ptr<codeVersionTable1_3::statusfld3>
//#define org_himalay_ccif_codeVersionTable1_3_statusfld3__NEW(x) {x =new codeVersionTable1_3::statusfld3();}
#define org_himalay_ccif_codeVersionTable1_3_statusfld3__NEW(x) {/** Serious **/x = org_himalay_ccif_codeVersionTable1_3_statusfld3__PTR_TYPE(new codeVersionTable1_3::statusfld3()); }
#define org_himalay_ccif_codeVersionTable1_3_statusfld3__INIT(x)
#define org_himalay_ccif_codeVersionTable1_3_statusfld3__DELETE(x)
#else
#define org_himalay_ccif_codeVersionTable1_3_statusfld3__PTR_TYPE codeVersionTable1_3::statusfld3*
#define org_himalay_ccif_codeVersionTable1_3_statusfld3__NEW(x) {x= new codeVersionTable1_3::statusfld3();}
#define org_himalay_ccif_codeVersionTable1_3_statusfld3__INIT(x)  x=NULL;
#define org_himalay_ccif_codeVersionTable1_3_statusfld3__DELETE(x)  {delete(x);x=NULL;}
#endif
...
#ifdef org_himalay_ccif_codeVersionTable1_3__USE_SMART_PTR
class codeVersionTable1_3;
typedef ::boost::shared_ptr<codeVersionTable1_3> codeVersionTable1_3Ptr;
#endif

class codeVersionTable1_3 :public   APDUBase_1Factory::APDUBase_1 { //Concrete type is codeVersionTable1_3
...
public:
    ...
    // statusfldInstance ---
public:
    org_himalay_ccif_codeVersionTable1_3_statusfld__PTR_TYPE statusfldInstance ;
    // statusfld2Instance ---
public:
    org_himalay_ccif_codeVersionTable1_3_statusfld2__PTR_TYPE statusfld2Instance ;
    // statusfld3Instance ---
public:
    org_himalay_ccif_codeVersionTable1_3_statusfld3__PTR_TYPE statusfld3Instance ;
    // codeFileByte ---
public:
...
public:
    codeVersionTable1_3 (); // throws Exception
    virtual ~codeVersionTable1_3 ();
public:
    int readNoHeader(DataInputStream& istream);// throws IOException
...
public:
    ...
    // public: org_himalay_ccif_codeVersionTable1_3_statusfld__PTR_TYPE getStatusfldInstance();

    // Setter for statusfldInstance
    // public: void setStatusfldInstance(org_himalay_ccif_codeVersionTable1_3_statusfld__PTR_TYPE val);

    // Getter for statusfld2Instance
    // public: org_himalay_ccif_codeVersionTable1_3_statusfld2__PTR_TYPE getStatusfld2Instance();

    // Setter for statusfld2Instance
    // public: void setStatusfld2Instance(org_himalay_ccif_codeVersionTable1_3_statusfld2__PTR_TYPE val);

    // Getter for statusfld3Instance
    // public: org_himalay_ccif_codeVersionTable1_3_statusfld3__PTR_TYPE getStatusfld3Instance();

    // Setter for statusfld3Instance
    // public: void setStatusfld3Instance(org_himalay_ccif_codeVersionTable1_3_statusfld3__PTR_TYPE val);
...
#endif // ORG_HIMALAY_CCIF_CODEVERSIONTABLE1_3
// End of code