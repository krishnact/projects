...
public  class OpenHoming extends   APDUBaseFactory.APDUBase { //Concrete type is OpenHoming
    ...
    public short length ;
        ...
        public OpenHoming () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("OpenHoming\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
