...
public:
    ...
    // dsgTunnelAddress ---
public:
    org_himalay_binmsg_util_IPv4Address__PTR_TYPE dsgTunnelAddress ;
    // source_ip_address ---
public:
    org_himalay_binmsg_util_IPv6Address__PTR_TYPE source_ip_address ;
    // destination_ip_address ---
public:
    org_himalay_binmsg_util_IPv6Address__PTR_TYPE destination_ip_address ;
    // source_port_number ---
public:
    ui16 source_port_number ;
    // destination_port_number ---
public:
    ui16 destination_port_number ;


public:
    LocationType_dsg_tunnel (); // throws Exception
