...
public  class LocationType_dsg_app_id extends   LocationTypeFactory.LocationType { //Concrete type is LocationType_dsg_app_id
    ...
    preRead();
        int retVal= 0;
                     ...
                     // read application_id
        {application_id=istream.readUnsignedShort(); retVal+=2;}
    ...
    preWrite();
        ...
        ostream.writeShort(application_id); retVal +=2;
postWrite();
        return retVal;
    }
    ...
    {
        dc.indent();dc.getPs().print("LocationType_dsg_app_id\n");
    dc.increaseIndent();
        int retVal= 0;
        // write application_id
        dc.indent();dc.getPs().println("application_id="+application_id+"(0x"+ Integer.toHexString(application_id) + ")" );
dc.decreaseIndent();
        return retVal;
    }
