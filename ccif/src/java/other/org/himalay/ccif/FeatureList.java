...
public  class FeatureList extends   APDUBaseFactory.APDUBase { //Concrete type is FeatureList
    ...
    public ByteArray featureList ;
        ...
        public FeatureList () // throws Exception
    {
            init();
    }
    ...
    private void init()
    {
        ...
        featureList= new ByteArray();featureList.setSizeType("FIRST_UI8");
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("FeatureList\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
        ...
        // write featureList
        dc.indent();dc.getPs().print("featureList: "+featureList.getSize()+"(0x"+Integer.toHexString(featureList.getSize())+")\n");this.featureList.dump(dc);
dc.decreaseIndent();
        return retVal;
    }
