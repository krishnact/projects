...
public  class RDC_report extends BinStruct implements PublicBinMsg {
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        // read RDC_centerFreq
        {
            RDC_centerFreq=istream.readUnsignedShort();
            retVal+=2;
        }
        // read RDC_transmitterPowerLevel
        {
            RDC_transmitterPowerLevel=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
        // read bf1
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        ostream.writeShort(RDC_centerFreq);
        retVal +=2;
        // write RDC_transmitterPowerLevel
        ostream.writeByte(RDC_transmitterPowerLevel);
        retVal +=1;
        // write bf1
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write RDC_centerFreq
        dc.indent();
        dc.getPs().println("RDC_centerFreq="+RDC_centerFreq+"(0x"+ Integer.toHexString(RDC_centerFreq) + ")" );
        // write RDC_transmitterPowerLevel
        dc.indent();
        dc.getPs().println("RDC_transmitterPowerLevel="+RDC_transmitterPowerLevel+"(0x"+ Integer.toHexString(RDC_transmitterPowerLevel) + ")" );
        // write bf1
        {
            dc.indent();
            ...
            dc.getPs().println(BitField_8.toDisplayString(getRDC_dataRate(),2));
        }
        dc.decreaseIndent();
        return retVal;
    }
