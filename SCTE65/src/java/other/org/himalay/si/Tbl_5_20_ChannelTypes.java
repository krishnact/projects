...
public class Tbl_5_20_ChannelTypes extends Table {
	...
	static {
		rowsMap.put(
				...
				new Row(
						"Normal",
						"Indicates that the record is a regular virtual channel record. For non-MPEG-2 channels, the waveform_type shall be defined as “normal.”"));
		rowsMap.put(
				new Range(1, 1),
				new Row(
						"Hidden",
						"Indicates that the record identifies a virtual channel that may not be"
		...
		rowsMap.put(
				...
				new Row(
						"Reserved",
						"Hosts are expected to treat virtual channel records of unknown"
