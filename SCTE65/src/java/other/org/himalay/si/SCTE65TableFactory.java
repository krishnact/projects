...
public static  SCTE65Table lastParsedObject= null;
    public static SCTE65Table createMsg(DataInputStream istream, IntegerHolder iHolder1) throws IOException
    {
int iRead=0;
...
iRead= retVal;
    ...
    public static SCTE65Table createMsg( org.himalay.si.SCTE65_TableHeader temp, DataInputStream dis, IntegerHolder iHolder) throws IOException
    {
        int iRead= 0;
        ...
        return retVal;
                ...
                public static abstract class SCTE65Table extends BinMessage implements FactoryProduct {
    public SCTE65Table() {
        super();
