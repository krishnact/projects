...
public  class CloseMmiReq extends   APDUBaseFactory.APDUBase { //Concrete type is CloseMmiReq
    ...
    public short dialogNumber ;
        ...
        public CloseMmiReq () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("CloseMmiReq\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
