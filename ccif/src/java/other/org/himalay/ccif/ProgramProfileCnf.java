...
public  class ProgramProfileCnf extends   APDUBaseFactory.APDUBase { //Concrete type is ProgramProfileCnf
    ...
    public short length ;
        ...
        public ProgramProfileCnf () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("ProgramProfileCnf\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
