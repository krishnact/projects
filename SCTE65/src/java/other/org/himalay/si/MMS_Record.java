...
public  class MMS_Record extends BinStruct implements PublicBinMsg{
    ...
    preRead();
        ...
        // read symbolRate
        {symbolRate=(long)(BinPrimitive.readUI32(istream) ); retVal+=4;}
    ...
    preWrite();
        ...
        // write symbolRate
        BinPrimitive.writeUI32(ostream,symbolRate); retVal +=4;
postWrite();
        return retVal;
    }
    ...
    {
        dc.indent();dc.getPs().print("MMS_Record\n");
    dc.increaseIndent();
        int retVal= 0;
        // write bf1
        {dc.indent();dc.getPs().print("transmissionSystem: ");dc.getPs().println(BitField_8.toDisplayString(getTransmissionSystem(),4));dc.indent();dc.getPs().print("innerCodignMode: ");dc.getPs().println(BitField_8.toDisplayString(getInnerCodignMode(),4));}
        // write bf2
        {dc.indent();dc.getPs().print("split_bitstream_mode: ");dc.getPs().println(BitField_8.toDisplayString(getSplit_bitstream_mode(),1));dc.indent();dc.getPs().print("modulation_format: ");dc.getPs().println(BitField_8.toDisplayString(getModulation_format(),5));}
        // write symbolRate
        dc.indent();dc.getPs().println("symbolRate="+symbolRate+"(0x"+ Long.toHexString(symbolRate)+")") ;
dc.decreaseIndent();
        return retVal;
    }
