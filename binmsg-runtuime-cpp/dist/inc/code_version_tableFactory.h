...
class code_version_tableFactory { 
    ...
    public: class code_version_table : public BinMessage {
    public: code_version_table();
    public: virtual ~code_version_table();
public: virtual int dump(DumpContext& dc)=0;
        public: virtual void setHeader(org_himalay_cl_cdl_Header__PTR_TYPE header)=0;
    public: virtual org_himalay_cl_cdl_Header__PTR_TYPE getHeader()=0;
    
        // code_version_table: acc1ffdb-d15b-4acb-82f6-2b27eb77146f used as header is false
...
//public: static  code_version_table* lastParsedObject;
    public: static org_himalay_cl_cdl_code_version_tableFactory_code_version_table__PTR_TYPE createMsg(DataInputStream& dis, int& iHolder) throw( IOException);
    public: static org_himalay_cl_cdl_code_version_tableFactory_code_version_table__PTR_TYPE createMsg( org_himalay_cl_cdl_Header__PTR_TYPE temp, DataInputStream& dis, int& iHolder) throw( IOException);
