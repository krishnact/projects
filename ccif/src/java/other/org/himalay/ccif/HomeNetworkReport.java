...
public  class HomeNetworkReport extends BinStruct implements PublicBinMsg {
    ...
    private void init()
    {
        ...
        // Initialize clients
        clients= new ArrayList<HomeNetworkReportMsg>();
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        // read maxClients
        {
            maxClients=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
        ...
        for (; istream.available() > 0 ; ) {
            HomeNetworkReportMsg temp;
            temp = new HomeNetworkReportMsg();
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        // write clients
        {
            ArrayList<HomeNetworkReportMsg> temp1 = clients;
            for (int iIdx=0; iIdx < temp1.getCount() ; iIdx++) {
                HomeNetworkReportMsg temp2    =    temp1.get(iIdx);
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write maxClients
        dc.indent();
        dc.getPs().println("maxClients="+maxClients+"(0x"+ Integer.toHexString(maxClients) + ")" );
        // write host_DRM_status
        dc.indent();
        ...
        // write clients
        {
            ArrayList<HomeNetworkReportMsg> temp1 = clients;
            for (int iIdx=0; iIdx < temp1.getCount() ; iIdx++) {
                HomeNetworkReportMsg element    = temp1.get(iIdx);
                dc.indent();
