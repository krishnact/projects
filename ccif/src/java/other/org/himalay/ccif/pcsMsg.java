...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("pcsMsg\n");
    dc.increaseIndent();
        int retVal= 0;
        // write bf1
        {dc.indent();dc.getPs().print("reserved: ");dc.getPs().println(BitField_8.toDisplayString(getReserved(),4));dc.indent();dc.getPs().print("major_channel_number: ");dc.getPs().println(BitField_8.toDisplayString(getMajor_channel_number(),10));dc.indent();dc.getPs().print("miner_channel_number: ");dc.getPs().println(BitField_8.toDisplayString(getMiner_channel_number(),10));}
dc.decreaseIndent();
        return retVal;
    }
