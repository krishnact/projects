...
// End of code
  ...
  preRead();
    int retVal= 0;
        ...
        {caPmtlisMngement=(short)(istream.readUnsignedByte()); retVal+=1;}
        // read programNumber
...
postRead();
    ...
    preWrite();
        ...
        ostream.writeByte(caPmtlisMngement); retVal +=1;
        // write programNumber
...
postWrite();
    ...
    public int dump(DumpContext dc) throws IOException 
    {
        dc.indent();dc.getPs().print("CaPmtSMode1_2\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
        ...
        // write caPmtlisMngement
        dc.indent();dc.getPs().println("caPmtlisMngement="+caPmtlisMngement+"(0x"+ Integer.toHexString(caPmtlisMngement) + ")" );
        // write programNumber
