...
public  class HardwareVersionId extends   ResourceFactory.Resource { //Concrete type is HardwareVersionId
    ...
    private void init()
    {
        ...
        // Initialize id
        id= new ByteArray();id.setSizeType("FIXED");id.setSize(4);
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("HardwareVersionId\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
