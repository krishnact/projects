...
public  class ResetPin extends BinStruct implements PublicBinMsg {
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        {
            resetpinControl=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        ostream.writeByte(resetpinControl);
        retVal +=1;
        postWrite();
        return retVal;
    }
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write resetpinControl
        dc.indent();
        dc.getPs().println("resetpinControl="+resetpinControl+"(0x"+ Integer.toHexString(resetpinControl) + ")" );
        dc.decreaseIndent();
        return retVal;
    }
