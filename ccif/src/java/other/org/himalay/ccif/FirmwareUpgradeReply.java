...
public  class FirmwareUpgradeReply extends   APDUBaseFactory.APDUBase { //Concrete type is FirmwareUpgradeReply
    ...
    public short length ;
        ...
        public FirmwareUpgradeReply () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("FirmwareUpgradeReply\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
