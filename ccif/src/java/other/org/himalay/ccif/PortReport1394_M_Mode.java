...
public  class PortReport1394_M_Mode extends BinStruct implements PublicBinMsg {
    ...
    private void init()
    {
        ...
        connectedDevices= new ArrayList<PortReport1394_MMsg>();
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        for (; istream.available() > 0 ; ) {
            PortReport1394_MMsg temp;
            temp = new PortReport1394_MMsg();
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        {
            ArrayList<PortReport1394_MMsg> temp1 = connectedDevices;
            for (int iIdx=0; iIdx < temp1.getCount() ; iIdx++) {
                PortReport1394_MMsg temp2    =    temp1.get(iIdx);
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write connectedDevices
        {
            ArrayList<PortReport1394_MMsg> temp1 = connectedDevices;
            for (int iIdx=0; iIdx < temp1.getCount() ; iIdx++) {
                PortReport1394_MMsg element    = temp1.get(iIdx);
                dc.indent();
