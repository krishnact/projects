...
public  class RatingRegion extends BinStruct implements PublicBinMsg {
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        {
            ratingRegionSetting=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        ostream.writeByte(ratingRegionSetting);
        retVal +=1;
        postWrite();
        return retVal;
    }
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write ratingRegionSetting
        dc.indent();
        dc.getPs().println("ratingRegionSetting="+ratingRegionSetting+"(0x"+ Integer.toHexString(ratingRegionSetting) + ")" );
        dc.decreaseIndent();
        return retVal;
    }
