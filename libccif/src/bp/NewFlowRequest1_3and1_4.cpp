...
// Constructor
NewFlowRequest1_3and1_4::NewFlowRequest1_3and1_4() {
    references= 0;
...
int NewFlowRequest1_3and1_4::readNoHeader(DataInputStream&  istream ) { // throws IOException
    int retVal = 0;
...
int NewFlowRequest1_3and1_4::read(DataInputStream&  istream ) { // throws IOException
    int retVal = 0;
    // read header
...
int NewFlowRequest1_3and1_4::write(DataOutputStream& ostream) { // throws IOException
...
int NewFlowRequest1_3and1_4::dump(DumpContext& dc) { // throws IOException
    dc.indent();
    dc.getPs().print("NewFlowRequest1_3and1_4\n");
    dc.increaseIndent();
    int retVal= 0;
    // write header
    if ( header != NULL ) {
...
// Getter for header
//org_himalay_ccif_APDUHeader__PTR_TYPE NewFlowRequest1_3and1_4::getHeader()
//{
//return this->header;
//}

// Setter for header
//void NewFlowRequest1_3and1_4::setHeader(org_himalay_ccif_APDUHeader__PTR_TYPE val)
//{
//this->header= val;
//}

// Getter for length
//ui8 NewFlowRequest1_3and1_4::getLength()
//{
//return this->length;
//}

// Setter for length
//void NewFlowRequest1_3and1_4::setLength(ui8 val)
//{
//this->length= val;
//}

// Getter for serviceType
//ui8 NewFlowRequest1_3and1_4::getServiceType()
//{
//return this->serviceType;
//}

// Setter for serviceType
//void NewFlowRequest1_3and1_4::setServiceType(ui8 val)
//{
//this->serviceType= val;
//}

// Getter for mpegSection
//org_himalay_ccif_ServiceMpegPid__PTR_TYPE NewFlowRequest1_3and1_4::getMpegSection()
//{
//return this->mpegSection;
//}

// Setter for mpegSection
//void NewFlowRequest1_3and1_4::setMpegSection(org_himalay_ccif_ServiceMpegPid__PTR_TYPE val)
//{
//this->mpegSection= val;
//}

// Getter for ipUnicast
//org_himalay_ccif_ServiceIPUnicast__PTR_TYPE NewFlowRequest1_3and1_4::getIpUnicast()
//{
//return this->ipUnicast;
//}

// Setter for ipUnicast
//void NewFlowRequest1_3and1_4::setIpUnicast(org_himalay_ccif_ServiceIPUnicast__PTR_TYPE val)
//{
//this->ipUnicast= val;
//}

// Getter for ipMulticast
//org_himalay_ccif_ServiceIPMulticast__PTR_TYPE NewFlowRequest1_3and1_4::getIpMulticast()
//{
//return this->ipMulticast;
//}

// Setter for ipMulticast
//void NewFlowRequest1_3and1_4::setIpMulticast(org_himalay_ccif_ServiceIPMulticast__PTR_TYPE val)
//{
//this->ipMulticast= val;
//}

int NewFlowRequest1_3and1_4::getSize() { // throws IOException
    int retVal = 0;

    return retVal;
}

void NewFlowRequest1_3and1_4::setHeader(org_himalay_ccif_APDUHeader__PTR_TYPE header)
{
    this->header= header;
}
