...
public  class LostFlowCnf extends   APDUBaseFactory.APDUBase { //Concrete type is LostFlowCnf
    ...
    public short statusField ;
        ...
        public LostFlowCnf () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("LostFlowCnf\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
