...
// Constructor
codeVersionTable1_2::statusfld::statusfld() {
    references= 0;
...
int codeVersionTable1_2::statusfld::readNoHeader(DataInputStream&  istream ) { // throws IOException
    int retVal = 0;
...
int codeVersionTable1_2::statusfld::read(DataInputStream&  istream ) { // throws IOException
    int retVal = 0;
...
int codeVersionTable1_2::statusfld::write(DataOutputStream& ostream) { // throws IOException
...
int codeVersionTable1_2::statusfld::dump(DumpContext& dc) { // throws IOException
    dc.indent();
...
//ui16 codeVersionTable1_2::statusfld::getFrequencyVector()
//{
//return this->frequencyVector;
//}

// Setter for frequencyVector
//void codeVersionTable1_2::statusfld::setFrequencyVector(ui16 val)
//{
//this->frequencyVector= val;
//}

// Getter for modulationType
//ui8 codeVersionTable1_2::statusfld::getModulationType()
//{
//return this->modulationType;
//}

// Setter for modulationType
//void codeVersionTable1_2::statusfld::setModulationType(ui8 val)
//{
//this->modulationType= val;
//}

// Getter for bf1
//ui16 codeVersionTable1_2::statusfld::getBf1()
//{
//return this->bf1;
//}

// Setter for bf1
//void codeVersionTable1_2::statusfld::setBf1(ui16 val)
//{
//this->bf1= val;
//}

int codeVersionTable1_2::statusfld::getReserved( ) {
    return ( this->bf1 & 0x0000e000 ) >> 13 ;
}

void codeVersionTable1_2::statusfld::setReserved(int val) {
    bf1=(  (this->bf1 & 0xffff1fff) | ( (val << 13 ) & 0x0000e000));
}

int codeVersionTable1_2::statusfld::getPid( ) {
    return ( this->bf1 & 0x00001fff ) >> 0 ;
}

void codeVersionTable1_2::statusfld::setPid(int val) {
    bf1=(  (this->bf1 & 0xffffe000) | ( (val << 0 ) & 0x00001fff));
}

int codeVersionTable1_2::statusfld::getSize() { // throws IOException
    int retVal = 0;
...
// member static classes
// Constructor
codeVersionTable1_2::statusfld2::statusfld2() {
    references= 0;
...
int codeVersionTable1_2::statusfld2::readNoHeader(DataInputStream&  istream ) { // throws IOException
    int retVal = 0;
...
int codeVersionTable1_2::statusfld2::read(DataInputStream&  istream ) { // throws IOException
    int retVal = 0;
    // read mcAddress
    retVal += mcAddress->read(istream);
...
int codeVersionTable1_2::statusfld2::write(DataOutputStream& ostream) { // throws IOException
...
int codeVersionTable1_2::statusfld2::dump(DumpContext& dc) { // throws IOException
    dc.indent();
...
//org_himalay_ccif_MacAddress__PTR_TYPE codeVersionTable1_2::statusfld2::getMcAddress()
//{
//return this->mcAddress;
//}

// Setter for mcAddress
//void codeVersionTable1_2::statusfld2::setMcAddress(org_himalay_ccif_MacAddress__PTR_TYPE val)
//{
//this->mcAddress= val;
//}

// Getter for sourceIpAddress
//org_himalay_ccif_IPddress__PTR_TYPE codeVersionTable1_2::statusfld2::getSourceIpAddress()
//{
//return this->sourceIpAddress;
//}

// Setter for sourceIpAddress
//void codeVersionTable1_2::statusfld2::setSourceIpAddress(org_himalay_ccif_IPddress__PTR_TYPE val)
//{
//this->sourceIpAddress= val;
//}

// Getter for destinationIpAddress
//org_himalay_ccif_IPddress__PTR_TYPE codeVersionTable1_2::statusfld2::getDestinationIpAddress()
//{
//return this->destinationIpAddress;
//}

// Setter for destinationIpAddress
//void codeVersionTable1_2::statusfld2::setDestinationIpAddress(org_himalay_ccif_IPddress__PTR_TYPE val)
//{
//this->destinationIpAddress= val;
//}

// Getter for sourcePortNumber
//ui16 codeVersionTable1_2::statusfld2::getSourcePortNumber()
//{
//return this->sourcePortNumber;
//}

// Setter for sourcePortNumber
//void codeVersionTable1_2::statusfld2::setSourcePortNumber(ui16 val)
//{
//this->sourcePortNumber= val;
//}

// Getter for destinatioPortNumber
//ui16 codeVersionTable1_2::statusfld2::getDestinatioPortNumber()
//{
//return this->destinatioPortNumber;
//}

// Setter for destinatioPortNumber
//void codeVersionTable1_2::statusfld2::setDestinatioPortNumber(ui16 val)
//{
//this->destinatioPortNumber= val;
//}

// Getter for applicationId
//ui16 codeVersionTable1_2::statusfld2::getApplicationId()
//{
//return this->applicationId;
//}

// Setter for applicationId
//void codeVersionTable1_2::statusfld2::setApplicationId(ui16 val)
//{
//this->applicationId= val;
//}

// Getter for modulationType
//ui8 codeVersionTable1_2::statusfld2::getModulationType()
//{
//return this->modulationType;
//}

// Setter for modulationType
//void codeVersionTable1_2::statusfld2::setModulationType(ui8 val)
//{
//this->modulationType= val;
//}

// Getter for bf2
//ui16 codeVersionTable1_2::statusfld2::getBf2()
//{
//return this->bf2;
//}

// Setter for bf2
//void codeVersionTable1_2::statusfld2::setBf2(ui16 val)
//{
//this->bf2= val;
//}

int codeVersionTable1_2::statusfld2::getPid( ) {
    return ( this->bf2 & 0x00001fff ) >> 0 ;
}

void codeVersionTable1_2::statusfld2::setPid(int val) {
    bf2=(  (this->bf2 & 0xffffe000) | ( (val << 0 ) & 0x00001fff));
}

int codeVersionTable1_2::statusfld2::getSize() { // throws IOException
    int retVal = 0;
...
// member static classes
// Constructor
codeVersionTable1_2::statusfld3::statusfld3() {
    references= 0;
...
int codeVersionTable1_2::statusfld3::readNoHeader(DataInputStream&  istream ) { // throws IOException
    int retVal = 0;
...
int codeVersionTable1_2::statusfld3::read(DataInputStream&  istream ) { // throws IOException
    int retVal = 0;
...
int codeVersionTable1_2::statusfld3::write(DataOutputStream& ostream) { // throws IOException
...
int codeVersionTable1_2::statusfld3::dump(DumpContext& dc) { // throws IOException
    dc.indent();
...
//org_himalay_ccif_IPddress__PTR_TYPE codeVersionTable1_2::statusfld3::getFtpServerAddress()
//{
//return this->ftpServerAddress;
//}

// Setter for ftpServerAddress
//void codeVersionTable1_2::statusfld3::setFtpServerAddress(org_himalay_ccif_IPddress__PTR_TYPE val)
//{
//this->ftpServerAddress= val;
//}

int codeVersionTable1_2::statusfld3::getSize() { // throws IOException
    int retVal = 0;
...
// Constructor
codeVersionTable1_2::codeVersionTable1_2() {
    references= 0;
    ...
    bf1 = 0;
    // statusfldInstance
    org_himalay_ccif_codeVersionTable1_2_statusfld__INIT(statusfldInstance)
    // statusfld2Instance
    org_himalay_ccif_codeVersionTable1_2_statusfld2__INIT(statusfld2Instance)
    // statusfld3Instance
    org_himalay_ccif_codeVersionTable1_2_statusfld3__INIT(statusfld3Instance)
    // codeFileByte
...
codeVersionTable1_2::~codeVersionTable1_2() {
    ...
    // statusfldInstance
    org_himalay_ccif_codeVersionTable1_2_statusfld__DELETE( statusfldInstance);
    // statusfld2Instance
    org_himalay_ccif_codeVersionTable1_2_statusfld2__DELETE( statusfld2Instance);
    // statusfld3Instance
    org_himalay_ccif_codeVersionTable1_2_statusfld3__DELETE( statusfld3Instance);
    // codeFileByte
...
int codeVersionTable1_2::readNoHeader(DataInputStream&  istream ) { // throws IOException
    int retVal = 0;
    ...
    if (getDownload_type()==0x00) {
        org_himalay_ccif_codeVersionTable1_2_statusfld__NEW( statusfldInstance);
        statusfldInstance->parent=this;
        retVal += statusfldInstance->read(istream);
    }
    // statusfld2Instance
    if (getDownload_type()==0x01) {
        org_himalay_ccif_codeVersionTable1_2_statusfld2__NEW( statusfld2Instance);
        statusfld2Instance->parent=this;
        retVal += statusfld2Instance->read(istream);
    }
    // statusfld3Instance
    if (getDownload_type()==0x02) {
        org_himalay_ccif_codeVersionTable1_2_statusfld3__NEW( statusfld3Instance);
...
int codeVersionTable1_2::read(DataInputStream&  istream ) { // throws IOException
    int retVal = 0;
    // read header
...
int codeVersionTable1_2::write(DataOutputStream& ostream) { // throws IOException
...
int codeVersionTable1_2::dump(DumpContext& dc) { // throws IOException
    dc.indent();
    dc.getPs().print("codeVersionTable1_2\n");
    dc.increaseIndent();
    int retVal= 0;
    // write header
    if ( header != NULL ) {
...
// Getter for header
//org_himalay_ccif_APDUHeader__PTR_TYPE codeVersionTable1_2::getHeader()
//{
//return this->header;
//}

// Setter for header
//void codeVersionTable1_2::setHeader(org_himalay_ccif_APDUHeader__PTR_TYPE val)
//{
//this->header= val;
//}

// Getter for length
//ui8 codeVersionTable1_2::getLength()
//{
//return this->length;
//}

// Setter for length
//void codeVersionTable1_2::setLength(ui8 val)
//{
//this->length= val;
//}

// Getter for configurationCountChange
//ui8 codeVersionTable1_2::getConfigurationCountChange()
//{
//return this->configurationCountChange;
//}

// Setter for configurationCountChange
//void codeVersionTable1_2::setConfigurationCountChange(ui8 val)
//{
//this->configurationCountChange= val;
//}

// Getter for statusField
//ui8 codeVersionTable1_2::getStatusField()
//{
//return this->statusField;
//}

// Setter for statusField
//void codeVersionTable1_2::setStatusField(ui8 val)
//{
//this->statusField= val;
//}

// Getter for pgmmsg
//ArrayList(codeVersionTableMsg) codeVersionTable1_2::getPgmmsg()
//{
//return this->pgmmsg;
//}

// Setter for pgmmsg
//void codeVersionTable1_2::setPgmmsg(ArrayList(codeVersionTableMsg) val)
//{
//this->pgmmsg= val;
//}

// Getter for bf1
//ui8 codeVersionTable1_2::getBf1()
//{
//return this->bf1;
//}

// Setter for bf1
//void codeVersionTable1_2::setBf1(ui8 val)
//{
//this->bf1= val;
//}

// Getter for statusfldInstance
//org_himalay_ccif_codeVersionTable1_2_statusfld__PTR_TYPE codeVersionTable1_2::getStatusfldInstance()
//{
//return this->statusfldInstance;
//}

// Setter for statusfldInstance
//void codeVersionTable1_2::setStatusfldInstance(org_himalay_ccif_codeVersionTable1_2_statusfld__PTR_TYPE val)
//{
//this->statusfldInstance= val;
//}

// Getter for statusfld2Instance
//org_himalay_ccif_codeVersionTable1_2_statusfld2__PTR_TYPE codeVersionTable1_2::getStatusfld2Instance()
//{
//return this->statusfld2Instance;
//}

// Setter for statusfld2Instance
//void codeVersionTable1_2::setStatusfld2Instance(org_himalay_ccif_codeVersionTable1_2_statusfld2__PTR_TYPE val)
//{
//this->statusfld2Instance= val;
//}

// Getter for statusfld3Instance
//org_himalay_ccif_codeVersionTable1_2_statusfld3__PTR_TYPE codeVersionTable1_2::getStatusfld3Instance()
//{
//return this->statusfld3Instance;
//}

// Setter for statusfld3Instance
//void codeVersionTable1_2::setStatusfld3Instance(org_himalay_ccif_codeVersionTable1_2_statusfld3__PTR_TYPE val)
//{
//this->statusfld3Instance= val;
//}

// Getter for codeFileByte
//org_himalay_msgs_runtime_ByteArray_PTR_TYPE codeVersionTable1_2::getCodeFileByte()
//{
//return this->codeFileByte;
//}

// Setter for codeFileByte
//void codeVersionTable1_2::setCodeFileByte(org_himalay_msgs_runtime_ByteArray_PTR_TYPE val)
//{
//this->codeFileByte= val;
//}

// Getter for codeVeriFicationCertiFication
//org_himalay_ccif_CodeVeriFicationCertiFication__PTR_TYPE codeVersionTable1_2::getCodeVeriFicationCertiFication()
//{
//return this->codeVeriFicationCertiFication;
//}

// Setter for codeVeriFicationCertiFication
//void codeVersionTable1_2::setCodeVeriFicationCertiFication(org_himalay_ccif_CodeVeriFicationCertiFication__PTR_TYPE val)
//{
//this->codeVeriFicationCertiFication= val;
//}

int codeVersionTable1_2::getDownload_type( ) {
    return ( this->bf1 & 0x000000f0 ) >> 4 ;
}

void codeVersionTable1_2::setDownload_type(int val) {
    bf1=(  (this->bf1 & 0xffffff0f) | ( (val << 4 ) & 0x000000f0));
}

int codeVersionTable1_2::getDownloadCommand( ) {
    return ( this->bf1 & 0x0000000f ) >> 0 ;
}

void codeVersionTable1_2::setDownloadCommand(int val) {
    bf1=(  (this->bf1 & 0xfffffff0) | ( (val << 0 ) & 0x0000000f));
}

int codeVersionTable1_2::getSize() { // throws IOException
    int retVal = 0;

    return retVal;
}

void codeVersionTable1_2::setHeader(org_himalay_ccif_APDUHeader__PTR_TYPE header)
{
    this->header= header;
}
