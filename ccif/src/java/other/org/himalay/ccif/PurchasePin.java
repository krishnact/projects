...
public  class PurchasePin extends BinStruct implements PublicBinMsg{
    ...
    private void init()
    {
        ...
        purchagePinList= new ByteArray();purchagePinList.setSizeType("FIRST_UI16");
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("PurchasePin\n");
    dc.increaseIndent();
        int retVal= 0;
        // write purchagePinList
        dc.indent();dc.getPs().print("purchagePinList: "+purchagePinList.getSize()+"(0x"+Integer.toHexString(purchagePinList.getSize())+")\n");this.purchagePinList.dump(dc);
dc.decreaseIndent();
        return retVal;
    }
