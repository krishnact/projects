...
public  class application_name_descriptor extends   app_desc_baseFactory.app_desc_base { //Concrete type is application_name_descriptor
    ...
    private void init()
    {
        ...
        ISO_639_Language_Code= new ByteArray();ISO_639_Language_Code.setSizeType("FIXED");ISO_639_Language_Code.setSize(3);
        // Initialize app_name
        app_name= new ByteArray();app_name.setSizeType("FIRST_UI8");
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("application_name_descriptor\n");
    dc.increaseIndent();
        int retVal= 0;
        // write desc_header
        if ( desc_header != null ) {dc.indent();dc.getPs().println("desc_header") ;retVal +=desc_header.dump(dc);}
        // write ISO_639_Language_Code
        dc.indent();dc.getPs().print("ISO_639_Language_Code: "+ISO_639_Language_Code.getSize()+"(0x"+Integer.toHexString(ISO_639_Language_Code.getSize())+")\n");this.ISO_639_Language_Code.dump(dc);
        // write app_name
        dc.indent();dc.getPs().print("app_name: "+app_name.getSize()+"(0x"+Integer.toHexString(app_name.getSize())+")\n");this.app_name.dump(dc);
dc.decreaseIndent();
        return retVal;
    }
