...
public  class FirmwareVerReportS_Mode extends BinStruct implements PublicBinMsg {
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        {
            firmwareVersion=istream.readUnsignedShort();
            retVal+=2;
        }
        // read fwareDate
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        ostream.writeShort(firmwareVersion);
        retVal +=2;
        // write fwareDate
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write firmwareVersion
        dc.indent();
        dc.getPs().println("firmwareVersion="+firmwareVersion+"(0x"+ Integer.toHexString(firmwareVersion) + ")" );
        // write fwareDate
        if ( fwareDate != null ) {
            dc.indent();
