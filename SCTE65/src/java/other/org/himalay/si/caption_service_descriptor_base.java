...
public  class caption_service_descriptor_base extends   SCTE65DescriptorFactory.SCTE65Descriptor { //Concrete type is caption_service_descriptor
...
caption_service_descriptor_base parent;
    public services (caption_service_descriptor_base parent) // throws Exception
    {
        this.parent= parent;
            init();
    }
    ...
    {
        // Initialize lnaguage
        lnaguage= new ByteArray();lnaguage.setSizeType("FIXED");lnaguage.setSize(3);
    ...
    preRead();
        ...
        {line21OrCaptionService=(short)(istream.readUnsignedByte()); retVal+=1;}
        // read bf33
    ...
    preWrite();
        ...
        ostream.writeByte(line21OrCaptionService); retVal +=1;
        // write bf33
        ostream.writeShort(bf33.getValue()); retVal +=2;
postWrite();
        return retVal;
    }
    ...
    {
        dc.indent();dc.getPs().print("services\n");
    dc.increaseIndent();
        int retVal= 0;
        // write lnaguage
        dc.indent();dc.getPs().print("lnaguage: "+lnaguage.getSize()+"(0x"+Integer.toHexString(lnaguage.getSize())+")\n");this.lnaguage.dump(dc);
        // write line21OrCaptionService
        dc.indent();dc.getPs().println("line21OrCaptionService="+line21OrCaptionService+"(0x"+ Integer.toHexString(line21OrCaptionService) + ")" );
        // write bf33
        {dc.indent();dc.getPs().print("easy_reader: ");dc.getPs().println(BitField_8.toDisplayString(getEasy_reader(),1));dc.indent();dc.getPs().print("wide_aspect_ratio: ");dc.getPs().println(BitField_8.toDisplayString(getWide_aspect_ratio(),1));}
dc.decreaseIndent();
        return retVal;
    }
    ...
    {
        bf33.setValue ( (bf33.getValue() & 0xffff7fff) | ( (val << 15 ) & 0x00008000));
    }
    ...
    {
        bf33.setValue ( (bf33.getValue() & 0xffffbfff) | ( (val << 14 ) & 0x00004000));
    }
...
postWrite();
    ...
    public int dump(DumpContext dc) throws IOException 
    {
        dc.indent();dc.getPs().print("caption_service_descriptor_base\n");
    dc.increaseIndent();
        int retVal= 0;
        // write desc_header
        if ( desc_header != null ) {dc.indent();dc.getPs().println("desc_header") ;retVal +=desc_header.dump(dc);}
        // write bf1
        {dc.indent();dc.getPs().print("number_of_service: ");dc.getPs().println(BitField_8.toDisplayString(getNumber_of_service(),5));}
dc.decreaseIndent();
        return retVal;
    }
