...
public  class PCpin extends BinStruct implements PublicBinMsg{
    ...
    private void init()
    {
        ...
        PCpinList= new ByteArray();PCpinList.setSizeType("FIRST_UI8");
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("PCpin\n");
    dc.increaseIndent();
        int retVal= 0;
        // write PCpinList
        dc.indent();dc.getPs().print("PCpinList: "+PCpinList.getSize()+"(0x"+Integer.toHexString(PCpinList.getSize())+")\n");this.PCpinList.dump(dc);
dc.decreaseIndent();
        return retVal;
    }
