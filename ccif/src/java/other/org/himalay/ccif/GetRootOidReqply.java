...
public  class GetRootOidReqply extends   APDUBaseFactory.APDUBase { //Concrete type is GetRootOidReqply
    ...
    public void setOidBytes(byte[] val)
    {
