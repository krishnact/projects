...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("SCTE65_TableHeader\n");
    dc.increaseIndent();
        int retVal= 0;
        // write messageType
        dc.indent();dc.getPs().println("messageType="+messageType+"(0x"+ Integer.toHexString(messageType) + ")" );
        // write bf1
        {dc.indent();dc.getPs().print("zero: ");dc.getPs().println(BitField_8.toDisplayString(getZero(),2));dc.indent();dc.getPs().print("reserved: ");dc.getPs().println(BitField_8.toDisplayString(getReserved(),2));dc.indent();dc.getPs().print("section_length: ");dc.getPs().println(BitField_8.toDisplayString(getSection_length(),12));}
dc.decreaseIndent();
        return retVal;
    }
