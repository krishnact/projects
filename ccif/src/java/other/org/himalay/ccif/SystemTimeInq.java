...
public  class SystemTimeInq extends   APDUBaseFactory.APDUBase { //Concrete type is SystemTimeInq
    ...
    public short length ;
    // responseInterval
    public short responseInterval ;

        public SystemTimeInq () // throws Exception
    {
            init();
    }
  ...
  preRead();
    int retVal= 0;
        ...
        {responseInterval=(short)(istream.readUnsignedByte()); retVal+=1;}
...
postRead();
    ...
    preWrite();
        ...
        ostream.writeByte(responseInterval); retVal +=1;
postWrite();
        return retVal;
    }
    ...
    {
        dc.indent();dc.getPs().print("SystemTimeInq\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
        ...
        // write responseInterval
        dc.indent();dc.getPs().println("responseInterval="+responseInterval+"(0x"+ Integer.toHexString(responseInterval) + ")" );
dc.decreaseIndent();
        return retVal;
    }
    ...
    //public short getResponseInterval()
    //{
    ...
    //public void setResponseInterval(short val)
    //{
