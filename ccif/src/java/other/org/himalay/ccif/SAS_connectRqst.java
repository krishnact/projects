...
public  class SAS_connectRqst extends   APDUBaseFactory.APDUBase { //Concrete type is SAS_connectRqst
    ...
    public short length ;
        ...
        public SAS_connectRqst () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("SAS_connectRqst\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
