...
public  class ApplicationInfoReqest extends   APDUBaseFactory.APDUBase { //Concrete type is ApplicationInfoReqest
    ...
    public int readNoHeader(DataInputStream istream) throws IOException
    {
        ...
        // read displayRow
        {
            displayRow=istream.readUnsignedShort();
            retVal+=2;
        }
        // read displayColumns
        {
            displayColumns=istream.readUnsignedShort();
            retVal+=2;
        }
        // read verticalScrolling
        {
            verticalScrolling=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
        // read horizontalScrolling
        {
            horizontalScrolling=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
        // read dataEntrySupport
        {
            dataEntrySupport=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
        // read HTMLSupport
        {
            HTMLSupport=(short)(istream.readUnsignedByte());
            retVal+=1;
        }
        // read htmlCapabilities
        if (HTMLSupport == 1) {
            htmlCapabilities = new HTMLCapabilities();
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        retVal +=1;
        // write displayRow
        ostream.writeShort(displayRow);
        retVal +=2;
        // write displayColumns
        ostream.writeShort(displayColumns);
        retVal +=2;
        // write verticalScrolling
        ostream.writeByte(verticalScrolling);
        retVal +=1;
        // write horizontalScrolling
        ostream.writeByte(horizontalScrolling);
        retVal +=1;
        // write dataEntrySupport
        ostream.writeByte(dataEntrySupport);
        retVal +=1;
        // write HTMLSupport
        ostream.writeByte(HTMLSupport);
        retVal +=1;
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write displayRow
        dc.indent();
        dc.getPs().println("displayRow="+displayRow+"(0x"+ Integer.toHexString(displayRow) + ")" );
        // write displayColumns
        dc.indent();
        dc.getPs().println("displayColumns="+displayColumns+"(0x"+ Integer.toHexString(displayColumns) + ")" );
        // write verticalScrolling
        dc.indent();
        dc.getPs().println("verticalScrolling="+verticalScrolling+"(0x"+ Integer.toHexString(verticalScrolling) + ")" );
        // write horizontalScrolling
        dc.indent();
        dc.getPs().println("horizontalScrolling="+horizontalScrolling+"(0x"+ Integer.toHexString(horizontalScrolling) + ")" );
        // write dataEntrySupport
        dc.indent();
        dc.getPs().println("dataEntrySupport="+dataEntrySupport+"(0x"+ Integer.toHexString(dataEntrySupport) + ")" );
        // write HTMLSupport
        dc.indent();
        dc.getPs().println("HTMLSupport="+HTMLSupport+"(0x"+ Integer.toHexString(HTMLSupport) + ")" );
        // write htmlCapabilities
