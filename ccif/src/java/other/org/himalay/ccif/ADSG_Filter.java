...
public  class ADSG_Filter extends BinStruct implements PublicBinMsg{
    ...
    preRead();
        int retVal= 0;
                     ...
                     // read tunnelID
        {tunnelID=(short)(istream.readUnsignedByte()); retVal+=1;}
        // read tunnelPriority
        {tunnelPriority=(short)(istream.readUnsignedByte()); retVal+=1;}
        // read source_IP_address
        {source_IP_address=(long)(BinPrimitive.readUI32(istream) ); retVal+=4;}
        // read source_IP_mask
        {source_IP_mask=(long)(BinPrimitive.readUI32(istream) ); retVal+=4;}
        // read destination_IP_address
        {destination_IP_address=(long)(BinPrimitive.readUI32(istream) ); retVal+=4;}
        // read destination_port_start
        {destination_port_start=istream.readUnsignedShort(); retVal+=2;}
        // read destination_port_end
        {destination_port_end=istream.readUnsignedShort(); retVal+=2;}
    ...
    preWrite();
        int retVal= 0;
                ...
                // write tunnelID
        ostream.writeByte(tunnelID); retVal +=1;
        // write tunnelPriority
        ostream.writeByte(tunnelPriority); retVal +=1;
        // write source_IP_address
        BinPrimitive.writeUI32(ostream,source_IP_address); retVal +=4;
        // write source_IP_mask
        BinPrimitive.writeUI32(ostream,source_IP_mask); retVal +=4;
        // write destination_IP_address
        BinPrimitive.writeUI32(ostream,destination_IP_address); retVal +=4;
        // write destination_port_start
        ostream.writeShort(destination_port_start); retVal +=2;
        // write destination_port_end
        ostream.writeShort(destination_port_end); retVal +=2;
postWrite();
        return retVal;
    }
    ...
    {
        dc.indent();dc.getPs().print("ADSG_Filter\n");
    dc.increaseIndent();
        int retVal= 0;
        // write tunnelID
        dc.indent();dc.getPs().println("tunnelID="+tunnelID+"(0x"+ Integer.toHexString(tunnelID) + ")" );
        // write tunnelPriority
        dc.indent();dc.getPs().println("tunnelPriority="+tunnelPriority+"(0x"+ Integer.toHexString(tunnelPriority) + ")" );
        // write source_IP_address
        dc.indent();dc.getPs().println("source_IP_address="+source_IP_address+"(0x"+ Long.toHexString(source_IP_address)+")") ;
        // write source_IP_mask
        dc.indent();dc.getPs().println("source_IP_mask="+source_IP_mask+"(0x"+ Long.toHexString(source_IP_mask)+")") ;
        // write destination_IP_address
        dc.indent();dc.getPs().println("destination_IP_address="+destination_IP_address+"(0x"+ Long.toHexString(destination_IP_address)+")") ;
        // write destination_port_start
        dc.indent();dc.getPs().println("destination_port_start="+destination_port_start+"(0x"+ Integer.toHexString(destination_port_start) + ")" );
        // write destination_port_end
        dc.indent();dc.getPs().println("destination_port_end="+destination_port_end+"(0x"+ Integer.toHexString(destination_port_end) + ")" );
dc.decreaseIndent();
        return retVal;
    }
