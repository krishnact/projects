...
public  class CpDataReqTransMission2_1 extends   APDUBase_1Factory.APDUBase_1 { //Concrete type is CpDataReqTransMission2_1
    ...
    public ByteArray DataType_id ;
        ...
        public CpDataReqTransMission2_1 () // throws Exception
    {
            init();
    }
...
postWrite();
    ...
    {
        dc.indent();dc.getPs().print("CpDataReqTransMission2_1\n");
    dc.increaseIndent();
        int retVal= 0;
        // write header
