...
@Created(date = "Fri Jan 29 01:28:31 EST 2016")
public class DNSQuery_v3 extends BinStruct implements PublicBinMsg {
  ...
  // questionsArray
  public ArrayList<Question_> questionsArray;
  // everythingElse
  public ByteArray everythingElse;

  public DNSQuery_v3() // throws Exception
       {
    init();
  }
  ...
  private void init() {
    ...
    // Initialize questionsArray
    questionsArray = new ArrayList<Question_>();
    questionsArray.setMemberSize(0);
    // Initialize everythingElse
    everythingElse = new ByteArray();
    everythingElse.setSizeType("EOS");
  }
  ...
  public int read(DataInputStream istream) throws IOException {
    ...
    // read questionsArray
    for (int iIdx = 0; iIdx < questions + (0); iIdx++) {
      Question_ temp;
      temp = new Question_();
      retVal += temp.read(istream);
      questionsArray.add(temp);
    }
    // read everythingElse
    {
      retVal += everythingElse.read(istream);
    }
  ...
  public int write(DataOutputStream ostream) throws IOException {
    ...
    {
        /** fix dependent sizes for questionsArray**/
      questions = (short) (questionsArray.getCount() - (0));
    }
    {
      /** fix dependent sizes for everythingElse**/
    }
    ...
    retVal += 2;
    // write questionsArray
    {
      ArrayList<Question_> temp1 = questionsArray;
      for (int iIdx = 0; iIdx < temp1.getCount(); iIdx++) {
        Question_ temp2 = temp1.get(iIdx);
        if (temp2 != null) retVal += temp2.write(ostream);
      }
    }
    // write everythingElse
    {
      retVal += everythingElse.write(ostream);
    }
    postWrite();
    return retVal;
  }
  ...
  public int dump(DumpContext dc) throws IOException {
    ...
    // write questionsArray
    {
      ArrayList<Question_> temp1 = questionsArray;
      for (int iIdx = 0; iIdx < temp1.getCount(); iIdx++) {
        Question_ element = temp1.get(iIdx);
        dc.indent();
    ...
    dc.getPs()
        .print(
            "everythingElse: "
                + everythingElse.getSize()
                + "(0x"
                + Integer.toHexString(everythingElse.getSize())
                + ")\n");
    this.everythingElse.dump(dc);
    dc.decreaseIndent();
    return retVal;
  }
  ...
  //}
  // Getter for questionsArray
  //public ArrayList<Question_> getQuestionsArray()
  //{
  //    return questionsArray ;
  //}

  // Setter for questionsArray
  //public void setQuestionsArray(ArrayList<Question_> val)
  //{
  //    this.questionsArray= val;
  //}
  // Getter for everythingElse
  //public ByteArray getEverythingElse()
  //{
  //    return everythingElse ;
  //}

  // Setter for everythingElse
  //public void setEverythingElse(ByteArray val)
  //{
  //    this.everythingElse= val;
  //}
  ...
  public int addToQuestionsArray(Question_ val) {
    questionsArray.add(val);
    return questionsArray.size();
  }

  public int removeFromQuestionsArray(Question_ val) {
    questionsArray.remove(val);
    return questionsArray.size();
  }

  public int removeNthFromQuestionsArray(int idx) {
    questionsArray.remove(idx);
    return questionsArray.size();
  }

  public int emptyQuestionsArray(int idx) {
    questionsArray.clear();
    return questionsArray.size();
  }

  public void setEverythingElse(byte[] val) {
    this.everythingElse.setData(val);
  }
