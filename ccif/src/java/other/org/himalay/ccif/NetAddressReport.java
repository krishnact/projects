...
public  class NetAddressReport extends BinStruct implements PublicBinMsg {
    ...
    {
        // Initialize ntAddrs
        ntAddrs= new ArrayList<NetAddressReportMsg>();
    ...
    public int read(DataInputStream istream) throws IOException
    {
        ...
        for (; istream.available() > 0 ; ) {
            NetAddressReportMsg temp;
            temp = new NetAddressReportMsg();
    ...
    public int write(DataOutputStream ostream) throws IOException
    {
        ...
        // write ntAddrs
        {
            ArrayList<NetAddressReportMsg> temp1 = ntAddrs;
            for (int iIdx=0; iIdx < temp1.getCount() ; iIdx++) {
                NetAddressReportMsg temp2    =    temp1.get(iIdx);
    ...
    public int dump(DumpContext dc) throws IOException
    {
        ...
        // write ntAddrs
        {
            ArrayList<NetAddressReportMsg> temp1 = ntAddrs;
            for (int iIdx=0; iIdx < temp1.getCount() ; iIdx++) {
                NetAddressReportMsg element    = temp1.get(iIdx);
                dc.indent();
